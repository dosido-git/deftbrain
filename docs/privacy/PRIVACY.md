...
If a tool offers to "remember" your work between sessions — DifficultTalkCoach, for example, saves your past topics and rehearsals — that data lives in your browser's `localStorage`. It does not leave your device. We can't see it, and clearing your browser data removes it.
...
If a tool we add later interacts with new third parties, this section will be updated at the same time the tool is added.
