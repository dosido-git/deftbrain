...
export const tools = [
{
  ...
  // Routing metadata — read by Tool Finder only (backend/lib/toolCatalog.js).
  // Says what this tool is for, what it takes, and what it is NOT for. The
  // blurb above sells; these lines route. Keep them true to the built tool.
  toolFinder: {
    problems: [
