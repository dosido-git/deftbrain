...
},
{
  ...
  seoTitle: "Stress-Test a Career, Skill or Long-Term Bet",
  title: "Future Proof",
  tagline: "Stress-test a career, skill, technology, investment or long-term bet — before you go all in",
  tags: [
    'career future', 'future of my job', 'skill worth learning', 'career resilience',
    'automation risk', 'ai job risk', 'technology outlook', 'investment thesis',
    'long-term decision', 'future scenarios', 'stress test career', 'stress test investment',
    'what should i learn', 'career pivot', 'low-regret move'
  ],
  icon: "🔮",
  categories: ['Pursuits', 'Veer'],
  headerColor: "#ccdfc4",
...

{
  ...
  seoTitle: "Analogy Generator: Explain Anything to Anyone",
...

{
  ...
  seoTitle: "Gift Idea Generator for the Hard to Shop For",
  title: "Giftology",
  tagline: "The perfect gift for the hardest person to shop for.",
  tags: [
    'gift ideas', 'personalized gift ideas', 'thoughtful gift ideas', 'hard to shop for',
    'gift for someone who has everything', 'what gift should i get', 'last-minute gift idea', 'gift on a budget',
    'birthday gift', 'thank you gift', 'gift for boss', 'gift for mom',
    'wedding gift', 'graduation gift', 'gift card message', 'gift presentation'
  ],
  icon: "🎁",
...

{
  ...
  seoTitle: "Presentation Coach & Speech Practice",
...

{
  ...
  tags: [
    'focus sounds', 'background noise', 'concentration sounds', 'ambient sound',
    'soundscape', 'white noise', 'pink noise', 'brown noise',
    'mask distractions', 'noisy workspace', 'voices distracting', 'work sounds',
    'study sounds', 'sensory focus', 'focus environment'
  ],
  icon: " 🎧",
  categories: ['Energy'],
  headerColor: "#b8dcd8",
...

{
  ...
  tags: [
    'stay in touch', 'losing touch', 'friendship drift', 'reconnect with friend',
    'reach out after a long time', 'what to say to a friend', 'keep in touch', 'friendship reminder',
    'contact rhythm', 'forgot to text', 'awkward reconnect', 'maintain friendships'
  ],
  icon: "💛",
  categories: ['Humans'],
  headerColor: "#e0b8b8",
...
},
{
  ...
  tags: ["negotiation", "negotiation strategy", "negotiation prep", "leverage", "salary negotiation", "raise", "freelance rate", "vendor negotiation", "lease negotiation", "price negotiation", "contract negotiation", "dispute", "counteroffer", "bargaining", "counter move", "negotiation email"],
  icon: "⚖️",
  categories: ['Pursuits', 'Veer'],
  headerColor: "#d4dde8",
...

{
  ...
  tags: [
    'comfort zone', 'comfort zone challenge', 'small challenge', 'micro challenge',
    'small step', 'try something new', 'do something uncomfortable', 'push myself',
    'build confidence', 'fear of trying', 'personal growth', 'gentle challenge',
    'get out of comfort zone', 'one small step'
  ],
  icon: "🫸",
  categories: ['Energy', 'Me'],
  headerColor: "#ccdfc4",
...

{
  ...
  seoTitle: "Laundry Helper: Stains, Care Labels & Rescue",
  title: "LaundroMat",
...
},
{
  ...
  seoTitle: "Repair Quote Checker: What Am I Actually Paying For?",
  title: "Quote Check",
...
},
{
  ...
  seoDescription: "Contest a parking or red-light camera ticket — honest case assessment, defense angles, evidence checklist, and a ready-to-send appeal letter. Free.",
...

{
  ...
  seoDescription: "Heard or read a confusing phrase — an idiom, slang, jargon, or something else? Say What? identifies what kind of expression it is and explains what it means, plainly and in context. Free.",
  ...
  categories: ['Discourse', 'Go Deep!'],
  headerColor: "#cfe3e6",
  description: "Heard or read a phrase that doesn't make sense? Enter it—or paste the sentence around it. Say What? tells you whether it's an idiom, slang, jargon, metaphor, euphemism, regional expression, workplace phrase, cultural reference, proverb, or something literal, then explains what it means in plain language and in your context.",
  guide: {
    overview: "Say What? identifies what kind of language a phrase actually is — idiom, slang, jargon, metaphor, euphemism, regional expression, workplace phrase, cultural reference, proverb, or plain literal language that just sounds unusual — then explains what it means, in plain language and, when you give it context, in that specific situation. It never invents what the speaker was really thinking, and when a phrase genuinely could mean more than one thing, it says so instead of picking one and moving on.",
    ...
    howToUse: [
      ...
      "➕ Not enough? Add more of the sentence and Say What? re-evaluates from scratch — it never treats its own earlier guess as a fact",
    ...
    tips: [
      "Context changes everything — the same words can be literal or figurative depending on the situation, and Say What? classifies the use, not just the words",
    ...
    pitfalls: [
      ...
      "For a whole document full of unfamiliar language — a lease, a contract, a policy — Jargon Assassin is the right tool; Say What? is for one phrase or sentence at a time",
