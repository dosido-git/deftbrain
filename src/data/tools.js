...

{
  ...
  seoDescription: "Diagnose and fix any bike problem with step-by-step guides, animated demos, and follow-up questions when standard repairs fail. Free trailside mechanic.",
...

{
  ...
  seoDescription: "Match your apology to the actual harm caused. Get the right level from 1 to 5, so you stop over-apologizing and under-owning, with templates for each. Free.",
...
},
{
  ...
  seoDescription: "Separate real urgency from anxiety urgency. Your tasks ranked by what actually breaks if you skip them, with a time-blocked plan and a panic button. Free.",
...

{
  ...
  seoDescription: "Dump every racing thought and have the chaos sorted into action items, decisions, and worries you can drop. Free, no signup. Find your real next step.",
...

{
  ...
  seoDescription: "Find the perfect focus playlist for your brain right now. Tempo, complexity, and genre tuned to move you from scattered to focused in minutes. Free.",
...

{
  ...
  seoDescription: "Should you buy it? Get instant fair-price analysis, total cost of ownership, cheaper alternatives, and an impulse check. Free research that stops overpaying.",
