...

{
  ...
  headerColor: "#ccdfc4",
  description: "9 modes for when you don't want to exercise: Right Now builds a workout from your energy, body complaints, and what happened today (bad sleep, long meeting, emotional day — 12 context triggers that actually change the routine). 2-Minute Floor for when even 5 minutes is too much. Body Relief targets specific problem areas. Environment Stack layers micro-movements onto things you're already doing. Sleep Prep winds you down for bed. Recovery handles the aftermath of life events — post-flight, post-migraine, rough day. My Week is a 7-day menu, not a mandate. Breathe offers guided breathing patterns. History tracks energy shifts; Prove It shows whether movement actually helps you, with your own numbers.",
  guide: {
