...
تَحلّ هذه الاتفاقية محلّ جميع الاتفاقيات السابقة. يجوز للعميل تعديل هذه الاتفاقية في أي وقت بنشر تحديثات على موقعه الإلكتروني.`,
  ...
  pt: {
    cd_upload: "Carregar o ficheiro",
    cd_upload_hint: "PDF ou texto · ou cola abaixo",
    cd_remove_file: "Remover",
    cd_err_too_large: "Esse ficheiro tem mais de 10 MB — cola o texto.",
    cd_err_read: "Não foi possível ler o ficheiro. Tenta colar o texto.",
    cd_tagline2: "Percebe o que estás a aceitar antes de assinar.",
    ...
    cd_example2_context: "Usamos este software de agendamento em toda a empresa. Chegou a fatura de renovação e está 40% acima do ano passado. Estou a tentar perceber se estamos presos.",
