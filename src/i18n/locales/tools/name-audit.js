...
export const nameAudit = {
  ...
  ja: {
    ...
    nau_explainer_impression: "第一印象はミリ秒で形成されます。このセクションは、何をしているか誰も知らないうちに、名前が投げかける直感的な反応、連想、個性を捉えます。",
    ...
    nau_explainer_radio: "誰かがポッドキャストで名前を聞いたとき、Googleで検索できますか？ラジオテストは、聞いただけで人々がどれくらいの頻度で名前を綴り間違えるかを予測します。",
    ...
    nau_explainer_seo: "人々は名前を検索して見つけられますか？一般的な、またはすでに人気の名前は、初日からSEOを困難な戦いにします。",
