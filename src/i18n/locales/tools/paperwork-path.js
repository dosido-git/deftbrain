// PaperworkPath — pp_* keys. English only for now (launch-first, localize as a
// follow-up pass — see deftbrain-localization-rollout memory). Missing keys in
// other languages fall back to this 'en' block automatically (src/i18n/index.js).
export const paperworkPath = {
  en: {
    pp_title: "Paperwork Path",
    pp_tagline: "The documents you need — and the order to handle them",
    pp_your_situation: "What you told us",
