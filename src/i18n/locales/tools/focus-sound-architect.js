...
export const focusSoundArchitect = {
  en: {
    ...
    fsa_intro: "Tell us what you are doing, what is distracting you, and what sounds you prefer. DeftBrain will build an appropriate soundscape and you can adjust every layer after it starts.",
  ...
  es: {
    ...
    fsa_intro: "Cuéntanos qué estás haciendo, qué te distrae y qué sonidos prefieres. DeftBrain creará un paisaje sonoro adecuado, y podrás ajustar cada capa después de empezar.",
  ...
  zh: {
    ...
    fsa_intro: "告诉我们你在做什么、什么在干扰你，以及你喜欢哪些声音。DeftBrain 会为你搭建合适的声景，开始后你可以调整每一层。",
  ...
  hi: {
    ...
    fsa_intro: "हमें बताइए कि आप क्या कर रहे हैं, आपका ध्यान क्या भटका रहा है, और आपको कौन-सी आवाज़ें पसंद हैं। DeftBrain इस स्थिति के लिए उपयुक्त साउंडस्केप बनाएगा, और शुरू होने के बाद आप हर परत को समायोजित कर सकते हैं।",
  ...
  ar: {
    ...
    fsa_intro: "أخبرنا بما تفعله، وما الذي يشتّت انتباهك، وأي الأصوات تفضّلها. سيُنشئ DeftBrain مشهدًا صوتيًا مناسبًا، ويمكنك ضبط كل طبقة بعد أن يبدأ.",
  ...
  pt: {
    ...
    fsa_intro: "Diga-nos o que está fazendo, o que está te distraindo e quais sons você prefere. DeftBrain vai montar uma paisagem sonora adequada, e você pode ajustar cada camada depois que ela começar.",
  ...
  fr: {
    ...
    fsa_intro: "Dites-nous ce que vous faites, ce qui vous distrait et quels sons vous préférez. DeftBrain construira un paysage sonore adapté, et vous pourrez ajuster chaque couche une fois lancé.",
  ...
  de: {
    ...
    fsa_intro: "Sag uns, was du tust, was dich ablenkt und welche Klänge du bevorzugst. DeftBrain baut ein passendes Klangbild, und du kannst nach dem Start jede Ebene anpassen.",
    fsa_quick_hint: "Beginne mit einem fertigen Klangbild. Nach dem Start kannst du es anpassen.",
    fsa_q1: "1. Was möchtest du tun?",
    ...
    // ── Header ──
    fsa_title: "Focus Sound Architect",
    fsa_tagline: "Klangbilder für deine Situation — und sie spielen wirklich",
  ...
  ja: {
    ...
    fsa_intro: "何をしているのか、何に気を取られているのか、どんな音がお好みかを教えてください。DeftBrainがそれに合った音響をつくります。始まったあとで各レイヤーを調整できます。",
  ...
  ko: {
    ...
    fsa_intro: "무엇을 하고 있는지, 무엇이 방해가 되는지, 어떤 소리를 선호하는지 알려 주세요. DeftBrain이 적절한 사운드스케이프를 만들어 드리며, 시작한 뒤에 각 레이어를 조정할 수 있습니다.",
  ...
  ru: {
    ...
    fsa_intro: "Расскажите нам, чем вы заняты, что вас отвлекает и какие звуки вы предпочитаете. DeftBrain соберёт подходящую звуковую среду, а после запуска вы сможете настроить каждый слой.",
  ...
  th: {
    ...
    fsa_intro: "บอกเราว่าคุณกำลังทำอะไร อะไรกำลังรบกวนคุณ และคุณชอบเสียงแบบไหน DeftBrain จะสร้างภูมิทัศน์เสียงที่เหมาะสมให้ และคุณปรับแต่งได้ทุกชั้นหลังจากเริ่มแล้ว",
  ...
  vi: {
    ...
    fsa_intro: "Hãy cho chúng tôi biết bạn đang làm gì, điều gì đang làm bạn xao nhãng và bạn thích những âm thanh nào. DeftBrain sẽ dựng một không gian âm thanh phù hợp, và bạn có thể điều chỉnh từng lớp sau khi bắt đầu.",
