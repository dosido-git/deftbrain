...
export const focusSoundArchitect = {
  en: {
    fsa_int_voices: "Voices or conversation",
    fsa_int_noise: "General background noise",
    fsa_int_quiet: "It is too quiet",
    fsa_int_restless: "I feel restless",
    fsa_int_sleepy: "I feel sleepy",
    fsa_int_atmosphere: "Nothing — I just want the right atmosphere",
    fsa_fb_distracting: "Too distracting",
    fsa_fb_sleepy: "Too sleepy",
    fsa_fb_harsh: "Too harsh / sharp",
    fsa_fb_monotone: "Too monotonous",
    fsa_fb_voices: "Still hearing voices",
    ...
    fsa_why_soft_activity: "Provides a soft sense of activity for people who prefer some background life.",
    fsa_why_slow_gentle: "Creates slow, gentle variation.",
    fsa_why_steady_less_bright: "Keeps the background steady and less bright.",
    fsa_why_low_freq: "Provides a steady, low-frequency texture.",
    fsa_why_no_transients: "Adds slow variation without sharp transients.",
    fsa_why_brighter_than_brown: "A brighter steady texture than brown noise.",
    fsa_why_modest_var: "Adds modest variation and background activity.",
    fsa_why_broad_masking: "Provides broad, steady masking around much of the speech range.",
    fsa_why_voice_texture: "Adds non-distinct voice-like texture that can make separate words less salient.",
    fsa_intro: "Tell me what you are doing, what is distracting you, and what sounds work for you. I will build a soundscape for the situation, and you can adjust every layer after it starts.",
    fsa_quick_hint: "Start with a ready-made soundscape. You can adjust it after it starts.",
    fsa_q1: "1. What are you trying to do?",
    fsa_q2: "2. What is getting in the way?",
    fsa_q2_hint: "This helps DeftBrain decide whether to mask, soften, energize, or simply create atmosphere.",
    fsa_q3: "3. Where are you?",
    ...
    fsa_closest_fit: "Pick the closest fit.",
    fsa_very_calm: "Very calm",
    fsa_energized: "Energized",
    fsa_how_long: "How long will you listen?",
    fsa_designing: "Designing…",
    fsa_design_btn: "Design my soundscape",
    // ── Header ──
    fsa_title: "Focus Sound Architect",
    fsa_tagline: "Soundscapes built for your situation — and they actually play",
    ...
    fsa_master: "Master",
    fsa_headphones_hint: "Binaural beats need headphones — on speakers they blur into a pulsing hum.",
  ...
  es: {
    fsa_int_voices: "Voces o conversación",
    fsa_int_noise: "Ruido de fondo en general",
    fsa_int_quiet: "Hay demasiado silencio",
    fsa_int_restless: "Me siento inquieto",
    fsa_int_sleepy: "Tengo sueño",
    fsa_int_atmosphere: "Nada, solo quiero el ambiente adecuado",
    fsa_fb_distracting: "Distrae demasiado",
    fsa_fb_sleepy: "Da demasiado sueño",
    fsa_fb_harsh: "Demasiado áspero o agudo",
    fsa_fb_monotone: "Demasiado monótono",
    fsa_fb_voices: "Sigo oyendo voces",
    ...
    fsa_why_soft_activity: "Aporta una sensación suave de actividad para quien prefiere algo de vida de fondo.",
    fsa_why_slow_gentle: "Crea una variación lenta y suave.",
    fsa_why_steady_less_bright: "Mantiene el fondo constante y menos brillante.",
    fsa_why_low_freq: "Aporta una textura constante de baja frecuencia.",
    fsa_why_no_transients: "Añade variación lenta sin transitorios bruscos.",
    fsa_why_brighter_than_brown: "Una textura constante más brillante que el ruido marrón.",
    fsa_why_modest_var: "Añade variación moderada y actividad de fondo.",
    fsa_why_broad_masking: "Ofrece un enmascaramiento amplio y constante en buena parte del rango del habla.",
    fsa_why_voice_texture: "Añade una textura vocal poco definida que puede hacer que las palabras sueltas destaquen menos.",
    fsa_intro: "Cuéntame qué estás haciendo, qué te distrae y qué sonidos te funcionan. Crearé un paisaje sonoro para la situación, y podrás ajustar cada capa después de empezar.",
    fsa_quick_hint: "Empieza con un paisaje sonoro ya preparado. Puedes ajustarlo después de que empiece.",
    fsa_q1: "1. ¿Qué intentas hacer?",
    fsa_q2: "2. ¿Qué se interpone?",
    fsa_q2_hint: "Esto ayuda a DeftBrain a decidir si enmascarar, suavizar, activar o simplemente crear ambiente.",
    fsa_q3: "3. ¿Dónde estás?",
    ...
    fsa_closest_fit: "Elige lo que más se acerque.",
    fsa_very_calm: "Muy tranquilo",
    fsa_energized: "Con energía",
    fsa_how_long: "¿Cuánto tiempo vas a escuchar?",
    fsa_designing: "Diseñando…",
    fsa_design_btn: "Diseñar mi paisaje sonoro",
    // ── Header ──
    fsa_title: "Focus Sound Architect",
    fsa_tagline: "Paisajes sonoros hechos para tu situación — y suenan de verdad",
    ...
    fsa_master: "General",
    fsa_headphones_hint: "Los tonos binaurales requieren auriculares — en altavoces se convierten en un zumbido pulsante.",
  ...
  zh: {
    fsa_int_voices: "说话声或交谈",
    fsa_int_noise: "一般的背景噪音",
    fsa_int_quiet: "太安静了",
    fsa_int_restless: "我坐不住",
    fsa_int_sleepy: "我犯困",
    fsa_int_atmosphere: "没什么，我只想要合适的氛围",
    fsa_fb_distracting: "太让人分心",
    fsa_fb_sleepy: "太让人犯困",
    fsa_fb_harsh: "太刺耳",
    fsa_fb_monotone: "太单调",
    fsa_fb_voices: "还是能听见说话声",
    ...
    fsa_why_soft_activity: "为喜欢一点背景生气的人提供柔和的活动感。",
    fsa_why_slow_gentle: "形成缓慢、柔和的变化。",
    fsa_why_steady_less_bright: "让背景保持稳定，亮度更低。",
    fsa_why_low_freq: "提供稳定的低频质感。",
    fsa_why_no_transients: "加入缓慢变化，没有尖锐的瞬态。",
    fsa_why_brighter_than_brown: "比棕噪音更明亮的稳定质感。",
    fsa_why_modest_var: "增加适度的变化和背景活动感。",
    fsa_why_broad_masking: "在大部分语音频段提供宽广而稳定的遮蔽。",
    fsa_why_voice_texture: "加入不清晰的人声质感，让单个词语不那么突出。",
    fsa_intro: "告诉我你在做什么、什么在干扰你、以及哪些声音对你有效。我会为这个情境搭建一套声景，开始后你可以调整每一层。",
    fsa_quick_hint: "先用现成的声景开始。开始后你可以再调整。",
    fsa_q1: "1. 你想做什么？",
    fsa_q2: "2. 什么在妨碍你？",
    fsa_q2_hint: "这能帮助 DeftBrain 判断该遮蔽、柔化、提振，还是只营造氛围。",
    fsa_q3: "3. 你在哪里？",
    ...
    fsa_closest_fit: "挑最接近的一个。",
    fsa_very_calm: "很平静",
    fsa_energized: "有活力",
    fsa_how_long: "你打算听多久？",
    fsa_designing: "正在设计…",
    fsa_design_btn: "为我设计声景",
    // ── Header ──
    fsa_title: "Focus Sound Architect",
    fsa_tagline: "为你的处境量身搭建的声景——而且真的能播放",
    fsa_start_over: "↺ 重新开始",
    ...
    fsa_master: "总音量",
    fsa_headphones_hint: "双耳节拍需要佩戴耳机——外放时会变成脉动的嗡嗡声。",
  ...
  hi: {
    fsa_int_voices: "आवाज़ें या बातचीत",
    fsa_int_noise: "आम पृष्ठभूमि शोर",
    fsa_int_quiet: "बहुत ज़्यादा सन्नाटा है",
    fsa_int_restless: "मन बेचैन है",
    fsa_int_sleepy: "नींद आ रही है",
    fsa_int_atmosphere: "कुछ नहीं — बस सही माहौल चाहिए",
    fsa_fb_distracting: "बहुत ध्यान भटकाता है",
    fsa_fb_sleepy: "बहुत नींद ला रहा है",
    fsa_fb_harsh: "बहुत तीखा या कड़ा",
    fsa_fb_monotone: "बहुत नीरस",
    fsa_fb_voices: "अब भी आवाज़ें सुनाई दे रही हैं",
    ...
    fsa_why_soft_activity: "जिन्हें थोड़ी पृष्ठभूमि हलचल पसंद है, उनके लिए हल्की सक्रियता का एहसास देता है।",
    fsa_why_slow_gentle: "धीमी, कोमल विविधता बनाता है।",
    fsa_why_steady_less_bright: "पृष्ठभूमि को स्थिर और कम चमकीला रखता है।",
    fsa_why_low_freq: "स्थिर, कम-आवृत्ति वाली बनावट देता है।",
    fsa_why_no_transients: "तेज़ झटकों के बिना धीमी विविधता जोड़ता है।",
    fsa_why_brighter_than_brown: "ब्राउन नॉइज़ से अधिक चमकीली स्थिर बनावट।",
    fsa_why_modest_var: "मध्यम विविधता और पृष्ठभूमि हलचल जोड़ता है।",
    fsa_why_broad_masking: "बोली की अधिकांश रेंज में व्यापक, स्थिर ढकाव देता है।",
    fsa_why_voice_texture: "अस्पष्ट आवाज़-जैसी बनावट जोड़ता है, जिससे अलग-अलग शब्द कम उभरते हैं।",
    fsa_intro: "मुझे बताइए कि आप क्या कर रहे हैं, आपका ध्यान क्या भटका रहा है, और कौन-सी आवाज़ें आपके लिए काम करती हैं। मैं इस स्थिति के लिए एक साउंडस्केप बनाऊँगा, और शुरू होने के बाद आप हर परत को समायोजित कर सकते हैं।",
    fsa_quick_hint: "किसी तैयार साउंडस्केप से शुरू करें। शुरू होने के बाद आप उसे बदल सकते हैं।",
    fsa_q1: "1. आप क्या करने की कोशिश कर रहे हैं?",
    fsa_q2: "2. रास्ते में क्या आ रहा है?",
    fsa_q2_hint: "इससे DeftBrain तय कर पाता है कि आवाज़ को ढकना है, नरम करना है, ऊर्जा देनी है, या बस माहौल बनाना है।",
    fsa_q3: "3. आप कहाँ हैं?",
    ...
    fsa_closest_fit: "जो सबसे करीब हो वह चुनें।",
    fsa_very_calm: "बहुत शांत",
    fsa_energized: "ऊर्जावान",
    fsa_how_long: "कितनी देर सुनेंगे?",
    fsa_designing: "डिज़ाइन हो रहा है…",
    fsa_design_btn: "मेरा साउंडस्केप बनाएँ",
    // ── Header ──
    fsa_title: "Focus Sound Architect",
    fsa_tagline: "आपकी स्थिति के लिए बना साउंडस्केप — और यह सचमुच बजता है",
    ...
    fsa_master: "मास्टर",
    fsa_headphones_hint: "बाइनॉरल बीट्स के लिए हेडफ़ोन ज़रूरी हैं — स्पीकर पर ये धड़कती भनभनाहट बन जाती हैं।",
  ...
  ar: {
    fsa_int_voices: "أصوات أو حديث",
    fsa_int_noise: "ضوضاء خلفية عامة",
    fsa_int_quiet: "الجو هادئ أكثر من اللازم",
    fsa_int_restless: "أشعر بعدم الاستقرار",
    fsa_int_sleepy: "أشعر بالنعاس",
    fsa_int_atmosphere: "لا شيء — أريد فقط الأجواء المناسبة",
    fsa_fb_distracting: "يشتت كثيرًا",
    fsa_fb_sleepy: "يبعث على النعاس",
    fsa_fb_harsh: "حاد أو قاسٍ أكثر من اللازم",
    fsa_fb_monotone: "رتيب أكثر من اللازم",
    fsa_fb_voices: "ما زلت أسمع الأصوات",
    ...
    fsa_why_soft_activity: "يمنح إحساسًا خفيفًا بالحركة لمن يفضّل بعض الحياة في الخلفية.",
    fsa_why_slow_gentle: "يخلق تنوّعًا بطيئًا ولطيفًا.",
    fsa_why_steady_less_bright: "يبقي الخلفية ثابتة وأقل سطوعًا.",
    fsa_why_low_freq: "يوفّر نسيجًا ثابتًا منخفض التردد.",
    fsa_why_no_transients: "يضيف تنوّعًا بطيئًا دون نتوءات حادة.",
    fsa_why_brighter_than_brown: "نسيج ثابت أكثر سطوعًا من الضجيج البني.",
    fsa_why_modest_var: "يضيف تنوّعًا معتدلًا وحركة في الخلفية.",
    fsa_why_broad_masking: "يوفّر حجبًا واسعًا وثابتًا على معظم نطاق الكلام.",
    fsa_why_voice_texture: "يضيف نسيجًا شبيهًا بالأصوات وغير واضح، ما يجعل الكلمات المفردة أقل بروزًا.",
    fsa_intro: "أخبرني بما تفعله، وما الذي يشتّت انتباهك، وأي الأصوات تناسبك. سأبني مشهدًا صوتيًا يناسب الموقف، ويمكنك ضبط كل طبقة بعد أن يبدأ.",
    fsa_quick_hint: "ابدأ بمشهد صوتي جاهز. يمكنك تعديله بعد أن يبدأ.",
    fsa_q1: "١. ما الذي تحاول فعله؟",
    fsa_q2: "٢. ما الذي يعترض طريقك؟",
    fsa_q2_hint: "يساعد هذا DeftBrain على تحديد ما إذا كان عليه الحجب أم التلطيف أم التنشيط أم مجرد خلق أجواء.",
    fsa_q3: "٣. أين أنت؟",
    ...
    fsa_closest_fit: "اختر الأقرب.",
    fsa_very_calm: "هادئ جدًا",
    fsa_energized: "مفعم بالنشاط",
    fsa_how_long: "كم ستستمع؟",
    fsa_designing: "جارٍ التصميم…",
    fsa_design_btn: "صمّم مشهدي الصوتي",
    // ── Header ──
    fsa_title: "Focus Sound Architect",
    fsa_tagline: "مشاهد صوتية مبنية لحالتك — وتُشغَّل فعلًا",
    ...
    fsa_master: "رئيسي",
    fsa_headphones_hint: "النبضات الثنائية تتطلب سماعات رأس — عبر مكبرات الصوت تتحول إلى طنين نابض.",
  ...
  pt: {
    fsa_int_voices: "Vozes ou conversa",
    fsa_int_noise: "Barulho de fundo em geral",
    fsa_int_quiet: "Está silencioso demais",
    fsa_int_restless: "Estou inquieto",
    fsa_int_sleepy: "Estou com sono",
    fsa_int_atmosphere: "Nada — só quero o clima certo",
    fsa_fb_distracting: "Distrai demais",
    fsa_fb_sleepy: "Dá muito sono",
    fsa_fb_harsh: "Áspero ou agudo demais",
    fsa_fb_monotone: "Monótono demais",
    fsa_fb_voices: "Ainda escuto vozes",
    ...
    fsa_why_soft_activity: "Dá uma sensação leve de atividade para quem prefere alguma vida ao fundo.",
    fsa_why_slow_gentle: "Cria uma variação lenta e suave.",
    fsa_why_steady_less_bright: "Mantém o fundo estável e menos brilhante.",
    fsa_why_low_freq: "Oferece uma textura estável de baixa frequência.",
    fsa_why_no_transients: "Acrescenta variação lenta sem transientes bruscos.",
    fsa_why_brighter_than_brown: "Uma textura estável mais brilhante que o ruído marrom.",
    fsa_why_modest_var: "Acrescenta variação modesta e atividade de fundo.",
    fsa_why_broad_masking: "Oferece um mascaramento amplo e estável em boa parte da faixa da fala.",
    fsa_why_voice_texture: "Acrescenta uma textura vocal pouco definida que pode tornar palavras isoladas menos salientes.",
    fsa_intro: "Diga-me o que está fazendo, o que está te distraindo e quais sons funcionam para você. Vou montar uma paisagem sonora para a situação, e você pode ajustar cada camada depois que ela começar.",
    fsa_quick_hint: "Comece com uma paisagem sonora pronta. Você pode ajustá-la depois que ela começar.",
    fsa_q1: "1. O que você está tentando fazer?",
    fsa_q2: "2. O que está atrapalhando?",
    fsa_q2_hint: "Isso ajuda o DeftBrain a decidir se deve mascarar, suavizar, energizar ou apenas criar atmosfera.",
    fsa_q3: "3. Onde você está?",
    ...
    fsa_closest_fit: "Escolha o mais próximo.",
    fsa_very_calm: "Bem calmo",
    fsa_energized: "Cheio de energia",
    fsa_how_long: "Por quanto tempo vai ouvir?",
    fsa_designing: "Criando…",
    fsa_design_btn: "Criar minha paisagem sonora",
    // ── Header ──
    fsa_title: "Focus Sound Architect",
    fsa_tagline: "Paisagens sonoras feitas para a sua situação — e que tocam de verdade",
    ...
    fsa_master: "Geral",
    fsa_headphones_hint: "Batidas binaurais exigem fones de ouvido — em alto-falantes viram um zumbido pulsante.",
  ...
  fr: {
    fsa_int_voices: "Des voix ou une conversation",
    fsa_int_noise: "Un bruit de fond général",
    fsa_int_quiet: "C’est trop silencieux",
    fsa_int_restless: "Je suis agité",
    fsa_int_sleepy: "J’ai sommeil",
    fsa_int_atmosphere: "Rien — je veux juste la bonne ambiance",
    fsa_fb_distracting: "Trop distrayant",
    fsa_fb_sleepy: "Trop endormant",
    fsa_fb_harsh: "Trop dur ou aigu",
    fsa_fb_monotone: "Trop monotone",
    fsa_fb_voices: "J’entends encore les voix",
    ...
    fsa_why_soft_activity: "Donne une légère impression d'activité à ceux qui préfèrent un peu de vie en fond.",
    fsa_why_slow_gentle: "Crée une variation lente et douce.",
    fsa_why_steady_less_bright: "Garde le fond stable et moins brillant.",
    fsa_why_low_freq: "Apporte une texture stable de basse fréquence.",
    fsa_why_no_transients: "Ajoute une variation lente sans transitoires brusques.",
    fsa_why_brighter_than_brown: "Une texture stable plus brillante que le bruit brun.",
    fsa_why_modest_var: "Ajoute une variation modérée et de l'activité de fond.",
    fsa_why_broad_masking: "Offre un masquage large et stable sur une bonne partie de la plage de la parole.",
    fsa_why_voice_texture: "Ajoute une texture vocale peu distincte qui peut rendre les mots isolés moins saillants.",
    fsa_intro: "Dites-moi ce que vous faites, ce qui vous distrait et quels sons vous conviennent. Je construirai un paysage sonore adapté à la situation, et vous pourrez ajuster chaque couche une fois lancé.",
    fsa_quick_hint: "Commencez par un paysage sonore prêt à l'emploi. Vous pourrez l'ajuster une fois lancé.",
    fsa_q1: "1. Qu'essayez-vous de faire ?",
    fsa_q2: "2. Qu'est-ce qui vous gêne ?",
    fsa_q2_hint: "Cela aide DeftBrain à décider s'il faut masquer, adoucir, dynamiser ou simplement créer une ambiance.",
    fsa_q3: "3. Où êtes-vous ?",
    ...
    fsa_closest_fit: "Choisissez ce qui s’en rapproche le plus.",
    fsa_very_calm: "Très calme",
    fsa_energized: "Plein d’énergie",
    fsa_how_long: "Combien de temps allez-vous écouter ?",
    fsa_designing: "Conception…",
    fsa_design_btn: "Concevoir mon paysage sonore",
    // ── Header ──
    fsa_title: "Focus Sound Architect",
    fsa_tagline: "Des paysages sonores conçus pour votre situation — et qui se jouent vraiment",
    ...
    fsa_master: "Général",
    fsa_headphones_hint: "Les battements binauraux nécessitent un casque — sur des enceintes ils deviennent un bourdonnement pulsé.",
  ...
  de: {
    fsa_int_voices: "Stimmen oder Gespräche",
    fsa_int_noise: "Allgemeine Hintergrundgeräusche",
    fsa_int_quiet: "Es ist zu still",
    fsa_int_restless: "Ich bin unruhig",
    fsa_int_sleepy: "Ich bin müde",
    fsa_int_atmosphere: "Nichts — ich will einfach die richtige Atmosphäre",
    fsa_fb_distracting: "Zu ablenkend",
    fsa_fb_sleepy: "Macht zu müde",
    fsa_fb_harsh: "Zu hart oder schrill",
    fsa_fb_monotone: "Zu monoton",
    fsa_fb_voices: "Ich höre die Stimmen noch",
    ...
    fsa_why_soft_activity: "Gibt ein sanftes Gefühl von Betrieb für alle, die etwas Leben im Hintergrund mögen.",
    fsa_why_slow_gentle: "Erzeugt eine langsame, sanfte Abwechslung.",
    fsa_why_steady_less_bright: "Hält den Hintergrund gleichmäßig und weniger hell.",
    fsa_why_low_freq: "Liefert eine gleichmäßige, tieffrequente Textur.",
    fsa_why_no_transients: "Bringt langsame Abwechslung ohne scharfe Transienten.",
    fsa_why_brighter_than_brown: "Eine gleichmäßige Textur, heller als braunes Rauschen.",
    fsa_why_modest_var: "Bringt moderate Abwechslung und Hintergrundbetrieb.",
    fsa_why_broad_masking: "Bietet breite, gleichmäßige Überdeckung über weite Teile des Sprachbereichs.",
    fsa_why_voice_texture: "Fügt eine undeutliche, stimmähnliche Textur hinzu, die einzelne Wörter weniger hervortreten lässt.",
    fsa_intro: "Sagen Sie mir, was Sie tun, was Sie ablenkt und welche Klänge für Sie funktionieren. Ich baue ein Klangbild für die Situation, und Sie können nach dem Start jede Ebene anpassen.",
    fsa_quick_hint: "Beginnen Sie mit einem fertigen Klangbild. Nach dem Start können Sie es anpassen.",
    fsa_q1: "1. Was möchten Sie tun?",
    fsa_q2: "2. Was steht im Weg?",
    fsa_q2_hint: "Das hilft DeftBrain zu entscheiden, ob überdeckt, abgemildert, belebt oder einfach Atmosphäre geschaffen werden soll.",
    fsa_q3: "3. Wo sind Sie?",
    fsa_q3_hint: "Optional, aber hilfreich, um das Maß der Überdeckung festzulegen.",
    fsa_q4: "4. Gibt es etwas, das Sie besonders mögen oder nicht hören möchten?",
    fsa_q4_hint: "Optional. Lassen Sie das Feld leer, dann wählt der Architekt für Sie.",
    fsa_avoid: "Vermeiden",
    fsa_energy: "Energie:",
    ...
    fsa_closest_fit: "Nimm, was am ehesten passt.",
    fsa_very_calm: "Sehr ruhig",
    fsa_energized: "Voller Energie",
    fsa_how_long: "Wie lange hörst du zu?",
    fsa_designing: "Wird gestaltet…",
    fsa_design_btn: "Mein Klangbild bauen",
    // ── Header ──
    fsa_title: "Focus Sound Architect",
    fsa_tagline: "Klangbilder für Ihre Situation — und sie spielen wirklich",
    ...
    fsa_master: "Gesamt",
    fsa_headphones_hint: "Binaurale Beats brauchen Kopfhörer — über Lautsprecher werden sie zu einem pulsierenden Brummen.",
  ...
  ja: {
    fsa_int_voices: "話し声や会話",
    fsa_int_noise: "全体的な環境音",
    fsa_int_quiet: "静かすぎる",
    fsa_int_restless: "落ち着かない",
    fsa_int_sleepy: "眠い",
    fsa_int_atmosphere: "特にない。ちょうどいい雰囲気がほしいだけ",
    fsa_fb_distracting: "気が散る",
    fsa_fb_sleepy: "眠くなりすぎる",
    fsa_fb_harsh: "耳に刺さる",
    fsa_fb_monotone: "単調すぎる",
    fsa_fb_voices: "まだ話し声が聞こえる",
    ...
    fsa_why_soft_activity: "背景に少し人の気配がほしい人に、やわらかな活動感を与えます。",
    fsa_why_slow_gentle: "ゆっくりとした穏やかな変化をつくります。",
    fsa_why_steady_less_bright: "背景を安定させ、明るさを抑えます。",
    fsa_why_low_freq: "安定した低音の質感を与えます。",
    fsa_why_no_transients: "鋭い立ち上がりのない、ゆっくりした変化を加えます。",
    fsa_why_brighter_than_brown: "ブラウンノイズより明るい、安定した質感です。",
    fsa_why_modest_var: "控えめな変化と背景の活気を加えます。",
    fsa_why_broad_masking: "話し声の帯域の多くにわたって、広く安定したマスキングを行います。",
    fsa_why_voice_texture: "はっきりしない人声のような質感を加え、個々の言葉を目立ちにくくします。",
    fsa_intro: "何をしているのか、何に気を取られているのか、どんな音が合うのかを教えてください。その状況に合った音響をつくります。始まったあとで各レイヤーを調整できます。",
    fsa_quick_hint: "できあいの音響から始めましょう。始まったあとで調整できます。",
    fsa_q1: "1. 何をしようとしていますか？",
    fsa_q2: "2. 何が妨げになっていますか？",
    fsa_q2_hint: "これは DeftBrain が、覆い隠すか、和らげるか、活気づけるか、ただ雰囲気をつくるかを判断する助けになります。",
    fsa_q3: "3. どこにいますか？",
    ...
    fsa_master: "マスター",
    fsa_headphones_hint: "バイノーラルビートはヘッドホン必須です。スピーカーでは脈打つうなり音になります。",
  ...
  ko: {
    fsa_int_voices: "말소리나 대화",
    fsa_int_noise: "전반적인 배경 소음",
    fsa_int_quiet: "너무 조용해요",
    fsa_int_restless: "안절부절못하겠어요",
    fsa_int_sleepy: "졸려요",
    fsa_int_atmosphere: "딱히 없어요 — 그냥 분위기만 맞추고 싶어요",
    fsa_fb_distracting: "너무 산만해요",
    fsa_fb_sleepy: "너무 졸려요",
    fsa_fb_harsh: "너무 날카로워요",
    fsa_fb_monotone: "너무 단조로워요",
    fsa_fb_voices: "아직 말소리가 들려요",
    ...
    fsa_why_soft_activity: "배경에 약간의 생기를 원하는 사람에게 부드러운 활동감을 줍니다.",
    fsa_why_slow_gentle: "느리고 부드러운 변화를 만듭니다.",
    fsa_why_steady_less_bright: "배경을 일정하게, 덜 밝게 유지합니다.",
    fsa_why_low_freq: "일정한 저주파 질감을 제공합니다.",
    fsa_why_no_transients: "날카로운 트랜지언트 없이 느린 변화를 더합니다.",
    fsa_why_brighter_than_brown: "브라운 노이즈보다 밝은 일정한 질감입니다.",
    fsa_why_modest_var: "적당한 변화와 배경 활동감을 더합니다.",
    fsa_why_broad_masking: "말소리 대역 상당 부분에 걸쳐 넓고 일정한 가림을 제공합니다.",
    fsa_why_voice_texture: "또렷하지 않은 목소리 같은 질감을 더해 개별 단어가 덜 두드러지게 합니다.",
    fsa_intro: "무엇을 하고 있는지, 무엇이 방해가 되는지, 어떤 소리가 잘 맞는지 알려 주세요. 그 상황에 맞는 사운드스케이프를 만들어 드리며, 시작한 뒤에 각 레이어를 조정할 수 있습니다.",
    fsa_quick_hint: "미리 만들어진 사운드스케이프로 시작하세요. 시작한 뒤에 조정할 수 있습니다.",
    fsa_q1: "1. 무엇을 하려고 하시나요?",
    fsa_q2: "2. 무엇이 방해가 되나요?",
    fsa_q2_hint: "이 답변은 DeftBrain이 소리를 덮을지, 부드럽게 할지, 활기를 줄지, 아니면 그저 분위기를 만들지 정하는 데 도움이 됩니다.",
    fsa_q3: "3. 어디에 계신가요?",
    ...
    fsa_closest_fit: "가장 가까운 것을 고르세요.",
    fsa_very_calm: "아주 차분하게",
    fsa_energized: "활기차게",
    fsa_how_long: "얼마나 들으실 건가요?",
    fsa_designing: "설계 중…",
    fsa_design_btn: "내 사운드스케이프 만들기",
    // ── Header ──
    fsa_title: "Focus Sound Architect",
    fsa_tagline: "당신의 상황에 맞춰 만든 사운드스케이프 — 실제로 재생됩니다",
    ...
    fsa_master: "마스터",
    fsa_headphones_hint: "바이노럴 비트는 헤드폰이 필요합니다 — 스피커로는 맥동하는 웅웅거림으로 들립니다.",
  ...
  ru: {
    fsa_int_voices: "Голоса или разговоры",
    fsa_int_noise: "Общий фоновый шум",
    fsa_int_quiet: "Слишком тихо",
    fsa_int_restless: "Не могу усидеть",
    fsa_int_sleepy: "Клонит в сон",
    fsa_int_atmosphere: "Ничего — просто хочу подходящую атмосферу",
    fsa_fb_distracting: "Слишком отвлекает",
    fsa_fb_sleepy: "Слишком усыпляет",
    fsa_fb_harsh: "Слишком резко",
    fsa_fb_monotone: "Слишком однообразно",
    fsa_fb_voices: "Всё ещё слышу голоса",
    ...
    fsa_why_soft_activity: "Даёт мягкое ощущение движения тем, кому нравится немного жизни на фоне.",
    fsa_why_slow_gentle: "Создаёт медленное, мягкое изменение.",
    fsa_why_steady_less_bright: "Держит фон ровным и менее ярким.",
    fsa_why_low_freq: "Даёт ровную низкочастотную фактуру.",
    fsa_why_no_transients: "Добавляет медленное изменение без резких скачков.",
    fsa_why_brighter_than_brown: "Ровная фактура, более яркая, чем коричневый шум.",
    fsa_why_modest_var: "Добавляет умеренное разнообразие и фоновое движение.",
    fsa_why_broad_masking: "Даёт широкую ровную маскировку на большей части речевого диапазона.",
    fsa_why_voice_texture: "Добавляет неразборчивую фактуру, похожую на голоса, из-за чего отдельные слова меньше выделяются.",
    fsa_intro: "Расскажите, чем вы заняты, что вас отвлекает и какие звуки вам подходят. Я соберу звуковую среду под эту ситуацию, а после запуска вы сможете настроить каждый слой.",
    fsa_quick_hint: "Начните с готовой звуковой среды. После запуска её можно настроить.",
    fsa_q1: "1. Что вы собираетесь делать?",
    fsa_q2: "2. Что вам мешает?",
    fsa_q2_hint: "Это помогает DeftBrain решить, что нужно: заглушить, смягчить, взбодрить или просто создать атмосферу.",
    fsa_q3: "3. Где вы находитесь?",
    ...
    fsa_closest_fit: "Выберите ближайшее.",
    fsa_very_calm: "Очень спокойно",
    fsa_energized: "Бодро",
    fsa_how_long: "Как долго будете слушать?",
    fsa_designing: "Создание…",
    fsa_design_btn: "Собрать мой звуковой ландшафт",
    // ── Header ──
    fsa_title: "Focus Sound Architect",
    fsa_tagline: "Звуковые среды под вашу ситуацию — и они действительно играют",
    ...
    fsa_master: "Общий",
    fsa_headphones_hint: "Бинауральные ритмы требуют наушников — через колонки они превращаются в пульсирующий гул.",
  ...
  th: {
    fsa_int_voices: "เสียงพูดหรือบทสนทนา",
    fsa_int_noise: "เสียงรบกวนทั่วไป",
    fsa_int_quiet: "เงียบเกินไป",
    fsa_int_restless: "รู้สึกอยู่ไม่สุข",
    fsa_int_sleepy: "รู้สึกง่วง",
    fsa_int_atmosphere: "ไม่มีอะไร แค่อยากได้บรรยากาศที่ใช่",
    fsa_fb_distracting: "ทำให้เสียสมาธิเกินไป",
    fsa_fb_sleepy: "ทำให้ง่วงเกินไป",
    fsa_fb_harsh: "แหลมหรือบาดหูเกินไป",
    fsa_fb_monotone: "ซ้ำซากเกินไป",
    fsa_fb_voices: "ยังได้ยินเสียงพูดอยู่",
    ...
    fsa_why_soft_activity: "ให้ความรู้สึกถึงความเคลื่อนไหวเบา ๆ สำหรับคนที่ชอบมีชีวิตชีวาอยู่เบื้องหลัง",
    fsa_why_slow_gentle: "สร้างการเปลี่ยนแปลงที่ช้าและนุ่มนวล",
    fsa_why_steady_less_bright: "ทำให้พื้นหลังคงที่และสว่างน้อยลง",
    fsa_why_low_freq: "ให้เนื้อเสียงความถี่ต่ำที่คงที่",
    fsa_why_no_transients: "เพิ่มการเปลี่ยนแปลงช้า ๆ โดยไม่มีเสียงกระชากแหลม",
    fsa_why_brighter_than_brown: "เนื้อเสียงคงที่ที่สว่างกว่าบราวน์นอยส์",
    fsa_why_modest_var: "เพิ่มความหลากหลายพอประมาณและความเคลื่อนไหวเบื้องหลัง",
    fsa_why_broad_masking: "ให้การกลบเสียงที่กว้างและคงที่ครอบคลุมช่วงเสียงพูดเป็นส่วนใหญ่",
    fsa_why_voice_texture: "เพิ่มเนื้อเสียงคล้ายเสียงคนที่ไม่ชัดเจน ทำให้คำแต่ละคำโดดเด่นน้อยลง",
    fsa_intro: "บอกฉันว่าคุณกำลังทำอะไร อะไรกำลังรบกวนคุณ และเสียงแบบไหนที่ได้ผลกับคุณ ฉันจะสร้างภูมิทัศน์เสียงให้เหมาะกับสถานการณ์ และคุณปรับแต่งได้ทุกชั้นหลังจากเริ่มแล้ว",
    fsa_quick_hint: "เริ่มจากภูมิทัศน์เสียงสำเร็จรูป คุณปรับได้หลังจากเริ่มแล้ว",
    fsa_q1: "1. คุณกำลังจะทำอะไร?",
    fsa_q2: "2. อะไรกำลังขวางอยู่?",
    fsa_q2_hint: "สิ่งนี้ช่วยให้ DeftBrain ตัดสินใจว่าจะกลบ ลดทอน กระตุ้น หรือเพียงสร้างบรรยากาศ",
    fsa_q3: "3. คุณอยู่ที่ไหน?",
    ...
    fsa_closest_fit: "เลือกอันที่ใกล้เคียงที่สุด",
    fsa_very_calm: "สงบมาก",
    fsa_energized: "มีพลัง",
    fsa_how_long: "จะฟังนานแค่ไหน",
    fsa_designing: "กำลังออกแบบ…",
    fsa_design_btn: "ออกแบบภูมิเสียงให้ฉัน",
    // ── Header ──
    fsa_title: "Focus Sound Architect",
    fsa_tagline: "ภูมิทัศน์เสียงที่สร้างมาเพื่อสถานการณ์ของคุณ — และเล่นได้จริง",
    ...
    fsa_master: "หลัก",
    fsa_headphones_hint: "เสียงไบนอเรอลต้องใช้หูฟัง — ถ้าเปิดผ่านลำโพงจะกลายเป็นเสียงหึ่งเป็นจังหวะ",
  ...
  vi: {
    fsa_int_voices: "Tiếng nói hoặc trò chuyện",
    fsa_int_noise: "Tiếng ồn nền nói chung",
    fsa_int_quiet: "Quá yên tĩnh",
    fsa_int_restless: "Tôi thấy bồn chồn",
    fsa_int_sleepy: "Tôi thấy buồn ngủ",
    fsa_int_atmosphere: "Không có gì — tôi chỉ muốn không khí phù hợp",
    fsa_fb_distracting: "Quá gây xao nhãng",
    fsa_fb_sleepy: "Quá gây buồn ngủ",
    fsa_fb_harsh: "Quá chói hoặc gắt",
    fsa_fb_monotone: "Quá đơn điệu",
    fsa_fb_voices: "Vẫn nghe thấy tiếng nói",
    ...
    fsa_why_soft_activity: "Mang lại cảm giác hoạt động nhẹ cho những ai thích có chút sinh khí ở nền.",
    fsa_why_slow_gentle: "Tạo ra sự thay đổi chậm và nhẹ nhàng.",
    fsa_why_steady_less_bright: "Giữ cho nền ổn định và bớt sáng.",
    fsa_why_low_freq: "Mang lại kết cấu tần số thấp ổn định.",
    fsa_why_no_transients: "Thêm thay đổi chậm mà không có tiếng gằn đột ngột.",
    fsa_why_brighter_than_brown: "Kết cấu ổn định, sáng hơn tiếng ồn nâu.",
    fsa_why_modest_var: "Thêm sự thay đổi vừa phải và hoạt động nền.",
    fsa_why_broad_masking: "Cung cấp khả năng che rộng và ổn định trên phần lớn dải tiếng nói.",
    fsa_why_voice_texture: "Thêm kết cấu giống giọng nói nhưng không rõ ràng, khiến từng từ bớt nổi bật.",
    fsa_intro: "Hãy cho tôi biết bạn đang làm gì, điều gì đang làm bạn xao nhãng và những âm thanh nào hợp với bạn. Tôi sẽ dựng một không gian âm thanh cho tình huống này, và bạn có thể điều chỉnh từng lớp sau khi bắt đầu.",
    fsa_quick_hint: "Bắt đầu với một không gian âm thanh dựng sẵn. Bạn có thể điều chỉnh sau khi nó bắt đầu.",
    fsa_q1: "1. Bạn đang định làm gì?",
    fsa_q2: "2. Điều gì đang cản trở bạn?",
    fsa_q2_hint: "Điều này giúp DeftBrain quyết định nên che lấp, làm dịu, tiếp thêm năng lượng, hay chỉ tạo không khí.",
    fsa_q3: "3. Bạn đang ở đâu?",
    ...
    fsa_closest_fit: "Chọn phương án gần nhất.",
    fsa_very_calm: "Rất bình tĩnh",
    fsa_energized: "Đầy năng lượng",
    fsa_how_long: "Bạn sẽ nghe trong bao lâu?",
    fsa_designing: "Đang thiết kế…",
    fsa_design_btn: "Thiết kế không gian âm thanh cho tôi",
    // ── Header ──
    fsa_title: "Focus Sound Architect",
    fsa_tagline: "Không gian âm thanh dựng cho tình huống của bạn — và thật sự phát được",
    ...
    fsa_master: "Tổng",
    fsa_headphones_hint: "Nhịp binaural cần tai nghe — qua loa ngoài sẽ thành tiếng ù dồn dập.",
