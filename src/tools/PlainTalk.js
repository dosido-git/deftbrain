...
const PlainTalk = ({ tool }) => {
  ...
  return (
    <div className={`min-h-screen ${c.cardAlt} py-6 px-4`}>
              ...
              <div className="flex items-center justify-between mt-2">
                <div className="flex items-center gap-3">
                  ...
                  <label htmlFor="pt-file"
                    className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold cursor-pointer transition-colors ${c.btnSecondaryondary}`}>
                    📎 Upload File
                  </label>
      ...
      <ActionBar content={''} title="Plain Talk" />
            ...
            {/* ─── CROSS-REFERENCES ─── */}
            <div className={`${c.card} border rounded-2xl shadow-lg p-5`}>
              <p className={`text-xs font-bold ${c.textMuteded} mb-3`}>🔗 Related Tools</p>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                <a href="/JargonAssassin" target="_blank" rel="noopener noreferrer"
                  ...
                  <p className={`text-[10px] ${c.textMuteded}`}>Deep jargon replacement</p></div>
                </a>
                <a href="/ComplaintEscalationWriter" target="_blank" rel="noopener noreferrer"
                  ...
                  <p className={`text-[10px] ${c.textMuteded}`}>Escalate based on analysis</p></div>
                </a>
                <a href="/DoctorVisitTranslator" target="_blank" rel="noopener noreferrer"
                  ...
                  <p className={`text-[10px] ${c.textMuteded}`}>Decode medical language</p></div>
                </a>
              </div>
            </div>
