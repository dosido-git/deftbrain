          ...
          <div className={`${c.card} border rounded-2xl p-5`}>
            {inputMethod === 'text' ? (
              <>
                ...
                <textarea value={leaseText} onChange={(e) => setLeaseText(e.target.value)} placeholder={t('ltd_paste_ph')} rows={10} className={`w-full p-4 border-2 rounded-xl text-sm resize-y focus:outline-none focus:ring-2 ${c.input}`} />
            ...
            <div className={`${c.card} border rounded-2xl p-5 space-y-4`}>
              ...
              <div>
                ...
                <textarea value={concerns} onChange={(e) => setConcerns(e.target.value)} placeholder={t('ltd_concerns_ph')} rows={2} className={`w-full p-3 border-2 rounded-xl text-sm resize-y focus:outline-none focus:ring-2 ${c.input}`} />
              </div>
            </div>
          ...
          <div className="space-y-5">
              ...
              <div className={`${c.card} border rounded-2xl p-5`}>
                ...
                {showAmendment && !amendment && (
                  <div className="space-y-3">
                    ...
                    <input type="text" value={propertyAddress} onChange={e => setPropertyAddress(e.target.value)} placeholder={t('ltd_property_address_ph')} className={`w-full px-3 py-2 rounded-xl border-2 text-xs ${c.input}`} />
            ...
            <div className={`${c.card} border rounded-2xl p-5`}>
              ...
              {showEmailSetup && !draftEmail && (
                <div className="space-y-3">
                  <input type="text" value={landlordName} onChange={e => setLandlordName(e.target.value)} placeholder={t('ltd_landlord_name_ph')} className={`w-full px-3 py-2.5 rounded-xl border-2 text-sm ${c.input}`} />
                  <input type="text" value={tenantName} onChange={e => setTenantName(e.target.value)} placeholder={t('ltd_tenant_name_ph')} className={`w-full px-3 py-2.5 rounded-xl border-2 text-sm ${c.input}`} />
            ...
            <div className={`${c.card} border rounded-2xl p-5 space-y-3`}>
              ...
              <input type="text" value={followupQ} onChange={e => setFollowupQ(e.target.value)} placeholder={t('ltd_followup_ph')} onKeyDown={e => e.key === 'Enter' && askFollowup()} className={`flex-1 px-3 py-2.5 rounded-xl border-2 text-sm ${c.input}`} />
