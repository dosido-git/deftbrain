        ...
        <div className="space-y-5">
          ...
          <div className={`${c.card} border rounded-2xl p-5`}>
            ...
            <div className={`${c.card} border rounded-2xl p-5 space-y-4`}>
              <div>
                <label className={`block text-xs font-bold uppercase tracking-wider mb-2 ${c.textMuted}`}>Location <span className={c.required}>*</span></label>
              ...
              <div>
                <label className={`block text-xs font-bold uppercase tracking-wider mb-2 ${c.textMuted}`}>Lease Type <span className={c.required}>*</span></label>
                ...
                <div className="space-y-3">
                  ...
                  {checklist.demand_letter_template && (
                    <div className={`p-3 rounded-xl border ${c.cardAlt}`}>
                      ...
                      <div className="mt-2"><CopyBtn content={checklist.demand_letter_template + BRAND} label="Copy letter" /></div>
                    </div>
                  )}
