...
// Five, rotated: a best-friend's milestone birthday missed, blunt feedback
// to a junior colleague in front of a room, a forgotten school pickup, an
// accidentally-spoiled surprise, and honest feedback that may not actually
// need an apology at all.
const EXAMPLES = [
  {
  view: 'calibrate',
  ...
  {
  view: 'calibrate',
  whatHappened: "In a team meeting I said a colleague's proposal 'had already been tried and didn't work'. It came out flatter than I meant it and the room went quiet. She said 'fair enough' and moved on. Afterwards someone messaged me privately to say it landed badly.",
  relationship: "A colleague I've worked alongside for about a year. We're friendly but not close. She's newer than me and more junior, which I did not think about until afterwards.",
  situation: "It was her first proposal to the wider group. What I said was true — we did try something similar in 2024 — but I said it in front of eleven people and I did not say the part about why it might work now. I genuinely do not know whether this needs an apology or whether raising it makes it bigger than it was.",
},
  {
  view: 'calibrate',
  whatHappened: "I forgot to pick up my kid from school. Got caught up in a meeting that ran long, phone on silent. The school called the emergency contact — my sister — who had to leave her own work to get him. He waited forty minutes thinking I forgot about him.",
  relationship: "My eight-year-old son, and separately my sister, who dropped everything to help.",
  situation: "This is the second time this year something like this has happened, though the first was much smaller. My son has not said much about it, which is not like him. My sister was gracious on the phone but I could hear she was rattled.",
},
  {
  view: 'calibrate',
  whatHappened: "My partner planned a surprise for our anniversary that I accidentally ruined by mentioning it out loud, not realizing they hadn't told me it was supposed to be a surprise for me — a dinner with old friends they'd flown in.",
  relationship: "My partner of six years.",
  situation: "They had been planning this quietly for two months. I found out I'd spoiled it when one of the friends texted asking if I liked the surprise. My partner laughed it off in front of everyone but has been quieter than usual since.",
},
  {
  view: 'calibrate',
  whatHappened: "I gave honest, critical feedback on my sister's business plan when she asked what I thought. She says I was harsh; I think I was just honest and she asked for my real opinion.",
  relationship: "My younger sister, who is about to quit her job to try this full-time.",
  situation: "She has asked three people for feedback and I am apparently the only one who raised concerns. I do not think I said anything false or unkind, but she has not brought it up again in two weeks and normally she calls me every few days.",
},
];
...
const Mend = ({ tool }) => {
  ...
  const loadExample = useCallback(() => {
    const ex = pickExample('Mend', EXAMPLES);
    setView(ex.view);
    setCalWhatHappened(ex.whatHappened);
    setCalForm({
      whatHappened: ex.whatHappened,
