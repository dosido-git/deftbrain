...
const EmailUrgencyTriager = ({ tool }) => {
  ...
  const loadExample = useCallback(() => {
    setEmailContent(t(pickExample('EmailUrgencyTriager', ['eut_example_emails', 'eut_example2_emails'])));
    setMode('triage');
  }, [setEmailContent, t]);
      ...
      {mode === 'input' && (
        <div className="space-y-4">
          ...
          <div className={`${c.card} border rounded-xl p-6 space-y-5`}>
            ...
            className={`relative w-full ${(!emailContent.trim()) ? c.btnIdle : c.btnPrimary} font-bold py-3 rounded-lg flex items-center justify-center gap-2`}>
