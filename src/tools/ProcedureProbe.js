...
const EXAMPLE = {
  procedure: 'Wisdom teeth removal (all four)',
  quote: '$2,400 out-of-pocket after insurance',
  provider: 'In-network oral surgeon, recommended by my regular dentist',
  insurance: 'PPO with $1,500 annual dental max',
  concerns: 'Whether all four really need to come out at once, what the typical recovery looks like, and whether the quote is reasonable',
  urgency: 'soon',
};
...
const ProcedureProbe = ({ tool }) => {
  ...
  const loadExample = useCallback(() => {
    ...
    setInsurance(EXAMPLE.insurance);
    setConcerns(EXAMPLE.concerns);
    setUrgency(EXAMPLE.urgency);
    setResults(null);
  }, [setProcedure, setQuote, setProvider, setInsurance, setConcerns, setUrgency, setResults]);
