  ...
  const loadExample = useCallback(() => {
    ...
    const ex = pickExample('BatchFlow', [
      { tasks: [
          ...
          ['bf_ex_task2', '45min', 'bf_ex_loc_desk'],
          ['bf_ex_task3', '20min', 'bf_ex_loc_errand'],
          ['bf_ex_task4', '30min', 'bf_ex_loc_desk'],
          ['bf_ex_task5', '5min',  'bf_ex_loc_phone'],
          ['bf_ex_task6', '60min', 'bf_ex_loc_desk'],
        ], meta: EXAMPLE_META },
      { tasks: [
          ['bf_ex2_task1', '20min', 'bf_ex_loc_errand'],
          ['bf_ex2_task2', '15min', 'bf_ex_loc_phone'],
          ['bf_ex2_task3', '5min',  'bf_ex_loc_phone'],
          ['bf_ex2_task4', '30min', 'bf_ex2_loc_home'],
    ...
    setDayType(ex.meta.dayType);
    setTimeAvail(ex.meta.timeAvail);
    setDumpMode(false);
  }, [setTasks, t]);
