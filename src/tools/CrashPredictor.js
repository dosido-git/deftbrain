...
const CrashPredictor = ({ tool }) => {
  ...
  const c = {
    ...
    chartGridStroke: isDark ? '#3f3f46' : '#fecaca',
    chartLabelFill:  isDark ? '#a1a1aa' : '#991b1b',
    goalDoneBg:      isDark ? 'bg-green-900/20' : 'bg-green-50',
    warnBadge:       isDark ? 'bg-red-900/30' : 'bg-red-100',
    customBadge:     isDark ? 'bg-purple-900/30' : 'bg-purple-100',
    heatHigh:        isDark ? 'bg-red-800/50' : 'bg-red-100',
    heatMod:         isDark ? 'bg-yellow-800/50' : 'bg-yellow-100',
      ...
      <div className="max-w-4xl mx-auto space-y-4">
        ...
        {mode === 'dashboard' && (
          <div className="space-y-4">
              ...
              {analysisHistory.length > 0 ? (
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    <div className={`${c.cardAlt} border ${c.border} rounded-lg p-3 text-center`}><p className={`text-xs ${c.textMuted}`}>Risk</p><p className={`text-lg font-bold ${c.text} uppercase`}>{analysisHistory[0].riskLevel}</p></div>
                    <div className={`${c.cardAlt} border ${c.border} rounded-lg p-3 text-center`}><p className={`text-xs ${c.textMuted}`}>Days to Crash</p><p className={`text-lg font-bold ${c.text}`}>{analysisHistory[0].daysUntilCrash??'—'}</p></div>
                    <div className={`${c.cardAlt} border ${c.border} rounded-lg p-3 text-center`}><p className={`text-xs ${c.textMuted}`}>Trajectory</p><p className={`text-sm font-bold ${c.text} capitalize`}>{analysisHistory[0].trajectory||'—'}</p></div>
                  </div>
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className={`${c.card} border ${c.border} rounded-lg p-3 text-center`}><p className={`text-2xl font-bold ${c.text}`}>{streak>0?`🔥${streak}`:'—'}</p><p className={`text-xs ${c.textMuted}`}>Streak</p></div>
              <div className={`${c.card} border ${c.border} rounded-lg p-3 text-center`}><p className={`text-2xl font-bold ${c.text}`}>{checkedInToday?'✅':'⬜'}</p><p className={`text-xs ${c.textMuted}`}>Today</p></div>
              <div className={`${c.card} border ${c.border} rounded-lg p-3 text-center`}><p className={`text-2xl font-bold ${c.text}`}>{logs.length}</p><p className={`text-xs ${c.textMuted}`}>Logged</p></div>
            </div>
            ...
            {!quickMode && (
              <div className={`${c.card} border ${c.border} rounded-xl shadow-lg p-5`}>
                ...
                <div className="space-y-5">
                  ...
                  <button onClick={()=>setShowBiometrics(!showBiometrics)} className={`text-sm font-medium ${c.textSecondary} flex items-center gap-1`}><span>📟 Biometrics</span><span className={c.textMuted}>(opt.)</span><span className="ml-1">{showBiometrics?'▲':'▼'}</span></button>
                  ...
                  <button onClick={()=>setShowWeather(!showWeather)} className={`text-sm font-medium ${c.textSecondary} flex items-center gap-1`}><span>🌤️ Weather</span><span className={c.textMuted}>(opt.)</span><span className="ml-1">{showWeather?'▲':'▼'}</span></button>
                  ...
                  <button onClick={()=>setShowCalendar(!showCalendar)} className={`text-sm font-medium ${c.textSecondary} flex items-center gap-1`}><span>📅 Commitments</span><span className={c.textMuted}>(opt.)</span><span className="ml-1">{showCalendar?'▲':'▼'}</span></button>
          ...
          <div ref={analysisRef} className="space-y-4">
            ...
            {analysis.burnout_risk_assessment && (
              <div className={`${c.card} border ${c.border} rounded-xl shadow-lg p-5`}>
                ...
                <div className="grid grid-cols-3 gap-3">
                  <div className={`${c.cardAlt} border ${c.border} rounded-lg p-3 text-center`}><p className={`text-xs ${c.textMuted}`}>Days</p><p className={`text-xl font-bold ${c.text}`}>{analysis.burnout_risk_assessment.days_until_likely_crash??'—'}</p></div>
                  <div className={`${c.cardAlt} border ${c.border} rounded-lg p-3 text-center`}><p className={`text-xs ${c.textMuted}`}>Trajectory</p><p className={`text-sm font-bold ${c.text} capitalize`}>{analysis.burnout_risk_assessment.trajectory||'—'}</p></div>
                  <div className={`${c.cardAlt} border ${c.border} rounded-lg p-3 text-center`}><p className={`text-xs ${c.textMuted}`}>Severity</p><p className={`text-sm font-bold ${c.text} capitalize`}>{analysis.burnout_risk_assessment.crash_severity_predicted||'—'}</p></div>
                </div>
              </div>
            )}
            ...
            <div className={`p-4 rounded-xl text-center ${c.cardAlt}`}>
              <p className={`text-xs ${c.textMuted}`}>⚠️ AI-generated pattern analysis based on your logged data. Not a medical diagnosis. If you're experiencing a health crisis, please contact a healthcare provider.</p>
            </div>
          </div>
        )}

        {mode==='analysis'&&!analysis&&!loading&&(
          <div className={`${c.card} border ${c.border} rounded-xl shadow-lg p-8 text-center`}><p className={`text-lg ${c.textMuted} mb-3`}>📊 No analysis yet</p>
        ...
        {mode === 'history' && (
          <div className="space-y-4">
            ...
            <div className={`${c.card} border ${c.border} rounded-xl shadow-lg p-5`}>
              ...
              {emergencyContacts.length>0&&<div className="space-y-2 mb-3">{emergencyContacts.map((ct,i)=><div key={i} className={`${c.cardAlt} border ${c.border} rounded-lg p-2 flex items-center justify-between`}><span className={`text-sm ${c.text}`}>{ct.name} <span className={c.textMuted}>({ct.relationship})</span></span><button onClick={()=>removeContact(i)} className={`text-xs ${c.textMuted} hover:text-red-500`}>✕</button></div>)}</div>}
