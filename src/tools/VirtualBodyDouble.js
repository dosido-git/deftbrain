...
import { focusSection } from '../utils/revealSection';
...
const VirtualBodyDouble = ({ tool }) => {
  ...
  useEffect(() => {
    ...
    // The scroll above is this tool's own, and stays. What it never did was
    // tell anyone using a screen reader that the view had changed.
    focusSection(viewTopRef.current);
