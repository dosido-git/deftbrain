  ...
  const renderInput = () => (
    <div className="space-y-4">
      ...
      <div className={`${c.card} border ${c.border} rounded-xl shadow-sm p-5`}>
        <label className={`text-base font-bold ${c.text} mb-1 block`}>What's in your kitchen? <span className={c.required}>*</span></label>
    ...
    return (
      <div className={`mt-6 p-4 rounded-2xl border ${c.histBg}`}>
        ...
        <p className={`text-xs ${c.textMuted} mt-3`}>
          Hit a wall mid-recipe? <a href="/RecipeChaosSolver" className={linkStyle}>🍳 Recipe Chaos Solver</a> rescues kitchen disasters in seconds.
        </p>
      </div>
    );
  };
    ...
    <div className={`space-y-4 ${c.text}`}>
      ...
      {!results && (
        <p className={`text-xs ${c.textMuted}`}>
          Cooking 5 things at once? <a href="/TaskAvalancheBreaker" className={linkStyle}>⛏️ Task Avalanche Breaker</a> breaks complex recipes into ordered micro-tasks first.
        </p>
      )}
      ...
      <div className={`${c.cardAlt} border ${c.border} rounded-xl p-3 text-center`}>
        <p className={`text-xs ${c.textMuted}`}>
          AI-generated meal plans — always use your own judgement about food safety and dietary needs.
        </p>
      </div>
      ...
      <div className={`${c.cardAlt} border ${c.border} rounded-xl p-4`}>
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <a href="/GhostWriter" className={`text-xs ${linkStyle}`}>✍️ Ghost Writer</a>
        </div>
      </div>
