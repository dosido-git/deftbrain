...
// Five, rotated across every meal type and skill level: an intermediate
// weeknight stir-fry, a beginner fridge-clearout dinner, an advanced
// sourdough-discard breakfast, a ten-minute beginner lunch, and a make-
// ahead snack for a gathering.
const EXAMPLES = [
  {
  ...
  {
  ingredients: 'half a bag of potatoes, three eggs, an onion, most of a block of cheddar, a tin of chickpeas, some wilting spinach, butter',
  servings: '2',
  timeAvailable: '30',
  skillLevel: 'beginner',
  mealType: 'dinner',
  preferences: 'nothing needs buying, and I would rather not use every pan I own',
},
  {
  ingredients: 'sourdough starter (active), bread flour, eggs, butter, whole milk, vanilla, cinnamon, brioche loaf gone slightly stale',
  servings: '4',
  timeAvailable: '40',
  skillLevel: 'advanced',
  mealType: 'breakfast',
  preferences: 'want to actually use the starter discard rather than throw it out, willing to do something a bit technical',
},
  {
  ingredients: 'canned tuna, mayo, celery, a lemon, sliced bread, lettuce, one tomato, a bag of pretzels',
  servings: '1',
  timeAvailable: '10',
  skillLevel: 'beginner',
  mealType: 'lunch',
  preferences: 'literally just want a sandwich that does not feel sad, no cooking',
},
  {
  ingredients: 'chickpeas, tahini, garlic, lemon, cumin, olive oil, pita, cucumber, a bit of feta',
  servings: '6',
  timeAvailable: '20',
  skillLevel: 'intermediate',
  mealType: 'snack',
  preferences: 'making this for a get-together, want something that can sit out for a couple hours without going bad',
},
];
