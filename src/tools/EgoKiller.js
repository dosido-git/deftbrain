        ...
        {!results && (
          <div className={`rounded-2xl border p-6 shadow-sm space-y-4 ${c.card} ${c.border}`}>
            <p className={`text-xs ${c.textMuted}`}>
              Want to pressure-test it through five attack vectors instead? <a href="/BeliefStressTest" className={linkStyle}>🧪 Belief Stress Test</a> is the structured version.
            </p>
            <div>
          ...
          <div ref={resultsRef} className="space-y-4">
            ...
            <div className={`rounded-xl border p-4 ${c.cardAlt} ${c.border}`}>
              ...
              <p className={`text-xs ${c.textMuted} mt-3`}>
                Want a structured stress-test instead? <a href="/BeliefStressTest" className={linkStyle}>🧪 Belief Stress Test</a> walks the belief through five attack vectors.
              </p>
            </div>
          </div>
        )}
