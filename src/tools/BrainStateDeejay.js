    ...
    <div className={`p-4 rounded-2xl border ${c.warning}`}>
      ...
      {showAdjust && (
        <div className="mt-3 space-y-3">
          ...
          <label htmlFor="bsd-adjust" className="sr-only">Describe what's not working</label>
      ...
      {results && (
        <div className={`${c.card} border ${c.border} rounded-xl p-4`}>
          <p className={`text-xs ${c.textMuted} text-center`}>
            Want to name what you're feeling first?{' '}
            <a href="/NameThatFeeling" className={linkStyle}>🎭 Name That Feeling</a>{' '}
            puts words to the state.
          </p>
        </div>
      )}
      {renderError()}
