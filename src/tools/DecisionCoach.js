    ...
    return (
      <div className={`mb-5 p-5 rounded-2xl border ${c.welcomeBg} relative`}>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
          {[['🧠','Decide','No options — just the answer'],['⚖️','Compare','Weigh options head-to-head'],['🎭','Gut check',"Trust your gut (or don't)"],['🔗','Chain','Solve cascading decisions'],['👥','Group','Compromise for everyone'],['🧬','DNA','The real reason you can\'t decide']].map(([e,t,d]) => (
      ...
      <div ref={resultsRef} className="space-y-4 mt-4">
        ...
        {showRejectionPicker ? (
          ...
          <div className="flex flex-wrap gap-2">
            {!timerLocked && <button onClick={() => setShowRejectionPicker(true)} disabled={loading} className={`flex-1 py-3 rounded-xl text-xs font-bold flex items-center justify-center gap-1.5 border ${c.btnDanger}`}><span>🚫</span> Not That</button>}
