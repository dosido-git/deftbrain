...
const ContrastReport = ({ tool }) => {
  ...
  useRegisterActions(buildFullText(), tool?.title || 'The Contrast Report');
        ...
        <div className="space-y-5">
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              ...
              <label className={`text-sm font-semibold ${c.text}`}>
                Path A <span className={c.required}>*</span>
              </label>
            </div>
            <textarea
              value={pathA}
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              ...
              <label className={`text-sm font-semibold ${c.text}`}>
                Path B <span className={c.required}>*</span>
              </label>
            </div>
            <textarea
              value={pathB}
        ...
        <div ref={resultsRef} className="space-y-6">
          ...
          <div className={`${c.cardAlt} border ${c.border} rounded-xl p-4`}>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <a href="/AlternatePath" className={`text-xs ${linkStyle}`}>🔀 Alternate Path</a>
            </div>
          </div>
