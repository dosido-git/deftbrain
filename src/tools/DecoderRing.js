...
const SOURCE_OPTIONS = [
  { value: 'text', emoji: '📱', key: 'dr_src_text' },
  { value: 'email', emoji: '📧', key: 'dr_src_email' },
  { value: 'slack', emoji: '💬', key: 'dr_src_slack' },
  { value: 'social', emoji: '🌐', key: 'dr_src_social' },
  { value: 'in-person', emoji: '🗣️', key: 'dr_src_inperson' },
  { value: 'letter', emoji: '📝', key: 'dr_src_letter' },
  { value: 'dating', emoji: '💕', key: 'dr_src_dating' },
  { value: 'other', emoji: '💬', key: 'dr_src_other' },
];

const RELATIONSHIP_OPTIONS = [
  { value: 'boss', emoji: '👔', key: 'dr_rel_boss' },
  { value: 'coworker', emoji: '🤝', key: 'dr_rel_coworker' },
  { value: 'client', emoji: '💼', key: 'dr_rel_client' },
  { value: 'partner', emoji: '💕', key: 'dr_rel_partner' },
  { value: 'ex', emoji: '💔', key: 'dr_rel_ex' },
  { value: 'friend', emoji: '🫂', key: 'dr_rel_friend' },
  { value: 'family', emoji: '👨‍👩‍👧', key: 'dr_rel_family' },
  { value: 'crush', emoji: '🦋', key: 'dr_rel_crush' },
  { value: 'landlord', emoji: '🏠', key: 'dr_rel_landlord' },
            ...
            <div className="space-y-3 mt-4">
              {results?.flags?.red_flags?.length > 0 && (
                <div className={`p-4 rounded-xl border ${c.redFlagBg}`}>
                  <p className={`text-xs font-bold ${c.redFlagText} mb-2`}>{t('dr_red_flags')}</p>
              ...
              {results?.flags?.green_flags?.length > 0 && (
                <div className={`p-4 rounded-xl border ${c.greenFlagBg}`}>
                  <p className={`text-xs font-bold ${c.greenFlagText} mb-2`}>{t('dr_green_flags')}</p>
