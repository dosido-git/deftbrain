...
const EXAMPLE = {
  activeTab: 'plan',
  fromLocation: 'Yoga studio on Hawthorne Ave',
  toLocation: 'My apartment, 8 blocks away on SE 21st',
  timeOfDay: 'evening_dark',
  walkDuration: '15',
  areaDesc: ['residential', 'mostly_lit'],
  routeFeatures: ['well_traveled'],
