...
const EXAMPLES = [
  ...
  timeOfDay: 'late',
  walkDuration: '20-30',
  areaDesc: ['downtown', 'transit'],
  routeFeatures: ['underpass', 'garage'],
  concerns: "First time in this city, arriving on a delayed train around 11:40pm with a suitcase, and I can't tell from the map which of these streets are busy at that hour.",
  viaDetails: 'Would rather add ten minutes than take the shortest line through anywhere quiet',
},
];;
...
const SafeWalk = ({ tool }) => {
  ...
  const loadExample = useCallback(() => {
    ...
    setAreaDesc(ex.areaDesc);
    setRouteFeatures(ex.routeFeatures);
    setConcerns(ex.concerns);
    setViaDetails(ex.viaDetails);
