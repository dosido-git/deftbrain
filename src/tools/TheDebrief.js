...
const TheDebrief = ({ tool }) => {
  ...
  const loadExample = useCallback(() => {
    ...
    setResults(null);
  }, [setMode, setMeetingType, setAttendees, setContext, setTone, setTranscript, setResults]);
      ...
      {mode !== 'series' ? (
        <div>
          <p className={'text-xs ' + c.textMuted + ' mb-3'}>
            Walked out wishing you'd said it better? <a href="/TheRunthrough" className={linkStyle}>🎙️ The Runthrough</a> lets you rehearse next time.
          </p>
        ...
        <div ref={resultsRef} className="space-y-4">
          ...
          <div className={'p-4 rounded-2xl border ' + c.card}>
            ...
            <div className={'space-y-1.5 text-xs ' + c.textSecondary}>
              <p>Need to send a difficult follow-up? <a href="/VelvetHammer" className={linkStyle}>Velvet Hammer</a> crafts the words.</p>
              <p>Drafting a longer recap or report? <a href="/GhostWriter" className={linkStyle}>Ghost Writer</a> does the heavy lifting.</p>
            </div>
          </div>
        </div>
      )}
