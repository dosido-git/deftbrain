...
const EXAMPLES = [
  {
    currentRole: 'Software engineer, 5 years backend Python/APIs. No management experience.',
    targetRole: 'Product Manager at a mid-size tech company',
    currentSkills: 'Python, system design, API architecture, SQL, cross-functional collaboration, some informal product work — written specs, run user interviews once',
    interests: 'User research, strategy, business impact, less interested in pure coding long-term',
    hoursPerWeek: 5,
  },
  {
    currentRole: 'Marketing coordinator, 3 years. Email campaigns, social media, basic analytics.',
    targetRole: 'UX Researcher',
    currentSkills: 'Survey design, customer interviews, data analysis in Excel, writing, stakeholder communication',
    interests: 'Human behavior, understanding why people make decisions, design thinking',
    hoursPerWeek: 8,
  },
];
const SkillGapMap = ({ tool }) => {
  ...
  const loadExample = () => {
    ...
    setCurrentRole(ex.currentRole);
    setTargetRole(ex.targetRole);
    setCurrentSkills(ex.currentSkills);
