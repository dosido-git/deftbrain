          ...
          <div className="space-y-6">
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      >
                        {adjustingIndex === index ? (
                          <><span className="inline-block animate-spin text-sm">⏳</span> Adjusting...</>
                        ) : (
                          <><span className="text-sm">➖</span> Too mushy?</>
                        )}
                      </button>
                      ...
                      >
                        {adjustingIndex === index ? (
                          ...
                          <><span className="text-sm">➕</span> More specific?</>
                        )}
                      </button>
                    </div>
                  </div>
            ...
            {results.personalization_tips && results.personalization_tips.length > 0 && (
              <div className={`border-2 rounded-xl p-5 ${c.warning}`}>
                <div className="flex items-start gap-3 mb-3">
                  <span className="text-lg flex-shrink-0 mt-1">✉️</span>
                  <h3 className="text-lg font-bold">
            ...
            {context === 'Post-interview' && (
              <p className={`text-xs text-center ${c.textMuted} mt-2`}>
                ...
                <a href="/DifficultTalkCoach" className={c.link}>Difficult Talk Coach</a>{' '}
