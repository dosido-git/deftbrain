...
const GratitudeDebtClearer = ({ tool }) => {
  ...
  }, [results, recipientName, editedMessages]);
    ...
    <div className={`space-y-4 ${c.text}`}>
      ...
      <div className={`${c.card} ${c.border} border rounded-xl shadow-lg p-6`} onKeyDown={handleFormKeyDown}>
          ...
          <div className="mb-6">
            ...
            >
              Who are you thanking? <span className={c.required}>*</span>
            </label>
          ...
          <div className="mb-6">
            <label 
              ...
              className={`block text-lg font-semibold ${c.text} mb-3`}
            >
              What are you grateful for? <span className={c.required}>*</span>
            </label>
            <textarea
              id="gratitude-points"
          ...
          <p className={`text-xs text-center ${c.textMuteded} mt-4`}>
            ...
            <a href="/ApologyCalibrator" className={linkStyle}>Apology Calibrator</a>{' '}
