...
// Five, rotated across every relationship type: a friend, a coworker, a
// parent, a neighbor, and a friend who lent money without making it
// awkward — the debts that are hardest to name out loud.
const EXAMPLES = [
  {
  ...
  {
    recipientName: 'my mom',
    gratitudePoints: "Flew out with two days' notice when my second kid was born early and stayed for three weeks, running the whole house without ever once making me feel like I was failing at it.",
    relationship: 'Family',
  },
  {
    recipientName: 'Mrs. Alvarez',
    gratitudePoints: "My neighbor of nine years. Took in every package, watered every plant, and fed the cat every single time we traveled — and always waved off any offer to pay her back.",
    relationship: 'Neighbor / community',
  },
  {
    recipientName: 'Tom',
    gratitudePoints: "Lent me money without being asked twice when I was between jobs, and never once brought it up again after I paid it back, or even before I did.",
    relationship: 'Friend',
  },
];
...
const GratitudeDebtClearer = ({ tool }) => {
  ...
  const generate = async () => {
    ...
    try {
      ...
      setClarify(null);
      setClarifyAnswer('');
      setTimeout(() => revealSection(resultsRef.current), 50);
    } catch (err) {
