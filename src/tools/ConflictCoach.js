...
const EXAMPLES = [
  {
    receivedMessage: "I just think it's interesting how you only show up when it's convenient for you. Must be nice to have that kind of flexibility.",
    relationship: 'Roommate',
    emotional: { angry: false, hurt: true, defensive: false, frustrated: true, calm: false, confused: false },
  },
  {
    receivedMessage: "Fine. Do whatever you want. I'm sure it'll be great.",
