...
const EXAMPLE = {
  sessionMode: 'single',
  sessionActivity: 'Finish the Q3 budget proposal — at least the headline numbers and the headcount section',
  sessionDurationMin: 45,
  upcomingObligations: '3pm 1:1 with my manager — would be ideal to have a draft ready by then',
  missedNeeds: 'Coffee, water, phone on Do Not Disturb',
};
const MILESTONES = [
...
const FocusPocus = ({ tool }) => {
  ...
  const loadExample = useCallback(() => {
    ...
    setSessionActivity(EXAMPLE.sessionActivity);
    setSessionDurationMin(EXAMPLE.sessionDurationMin);
    setUpcomingObligations(EXAMPLE.upcomingObligations);
    setMissedNeeds(EXAMPLE.missedNeeds);
  }, [setSessionMode, setSessionActivity, setSessionDurationMin, setUpcomingObligations, setMissedNeeds]);
