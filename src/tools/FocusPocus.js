...
// Five, rotated across the duration range and with/without a defined
// 'enough' — a vague task with no exit condition is the harder case the
// tool has to handle just as well as a precisely scoped one.
const EXAMPLES = [
  ...
  { task: 'Write the difficult performance review', enough: 'Get a rough first draft down, even if it is clumsy', minutes: 60 },
  { task: 'Clean out the garage', enough: '', minutes: 25 },
];
