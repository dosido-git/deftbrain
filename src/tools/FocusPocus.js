...
const EXAMPLE = {
  sessionMode: 'single',
  activityKey: 'fpc_ex_activity',
  sessionDurationMin: 45,
  obligationsKey: 'fpc_ex_obligations',
  missedKey: 'fpc_ex_missed',
};
...
const FocusPocus = ({ tool }) => {
  ...
  const loadExample = useCallback(() => {
    setSessionMode(EXAMPLE.sessionMode);
    setSessionActivity(t(EXAMPLE.activityKey));
    setSessionDurationMin(EXAMPLE.sessionDurationMin);
    setUpcomingObligations(t(EXAMPLE.obligationsKey));
    setMissedNeeds(t(EXAMPLE.missedKey));
