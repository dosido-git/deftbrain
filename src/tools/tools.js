...
// TaskAvalancheBreaker-metadata.js
{
  ...
  description: "Turn overwhelming projects into 5-minute micro-tasks. Built for executive dysfunction, ADHD, and 'too big to start' paralysis. No decisions required.",
  ...
  featured: true,
  guide: {
    overview: "The Task Avalanche Breaker converts overwhelming projects into ultra-specific micro-tasks that require ZERO decision-making. Built specifically for people with executive dysfunction, ADHD, or anyone experiencing 'too big to start' paralysis. Each task is broken down to 2-5 minute chunks with clear completion criteria and momentum-building sequencing.",
    ...
    quickReference: {
      ...
      "For": "Executive dysfunction, ADHD, task paralysis",
  ...
  tags: ["Productivity", "ADHD Support", "Task Management", "Executive Function"],
  ...
  benefits: [
    ...
    "Perfect for ADHD and executive dysfunction"
  ],
  ...
  // EmailUrgencyTriager-metadata.js
{
...
},
  {
    ...
    category: "Health",
    icon: "🧱",
    description: "Blocks distraction sites and shows a study countdown timer.",
    tagline: "Block distractions and lock in your study session",
    
    guide: {
      overview: "FocusWall blocks your most distracting websites and shows a full-screen countdown timer until your study session ends. Makes breaking focus inconvenient enough that you stay on task.",
      
      howToUse: [
        "Set study duration (e.g., 50 minutes)",
        "Select sites to block (social media, YouTube, games)",
        "Start FocusWall",
        "Full-screen timer appears, distractions are blocked",
        "Take a break when timer ends"
      ],
      
      tips: [
        "Use Pomodoro method: 25-min work, 5-min break, repeat",
        "Block your phone notifications too for maximum focus",
        "First few sessions feel hard, then become automatic"
      ]
    }
  },
...
// FriendshipFadeAlerter-metadata.js
{
  ...
  guide: {
    ...
    example: {
      scenario: "You have ADHD and lost track of time. Your close friend Sarah - you talk monthly - last contacted 47 days ago (17 days overdue). You feel guilty and don't know what to say since it's been so long. You're avoiding reaching out because of shame.",
    ...
    tips: [
      ...
      "CELEBRATE successes - reconnection counter shows you ARE maintaining relationships, proof against ADHD shame spiral.",
    ...
    pitfalls: [
      ...
      "Don't ignore yellow warnings thinking 'I still have time' - ADHD time-blindness means yellow becomes red fast. Act when it turns yellow.",
...
// TimeVanishingExplainer-metadata.js
{
  ...
  guide: {
    overview: "Masking (hiding autistic/ADHD traits, code-switching) costs enormous energy but is invisible. This tool tracks masking effort across interactions to show which situations drain most, how much total weekly cost, and validate that your exhaustion is real work.",
...
{
  id: "HyperfocusInterrupter",
  title: "Hyperfocus Interrupter",
  category: "Mind & Energy",
  icon: "⏰",
  description: "Breaks deep ADHD hyperfocus before you forget to eat, drink, move, or attend obligations. Escalating alerts (gentle → firm → forceful) with mandatory action checklists. Monitors how long you've been focused and what physical needs you've missed.",
  tagline: "Gentle nudges before you forget to eat or sleep",
  
  guide: {
    overview: "ADHD hyperfocus feels productive but borrows from your body's resources. Hours pass unnoticed while you skip meals, water, bathroom breaks, and medication. This tool monitors duration and escalates interruptions before physical harm.",
    
    howToUse: [
      "Tell it what you're hyperfocusing on and how long so far",
      "Note any missed needs (meals, water, medication, appointments)",
      "Get current alert level and mandatory break requirements",
      "Complete the action checklist before dismissing interruption",
      "Return to work after addressing physical needs"
    ],
    
    example: {
      scenario: "You've been coding for 4.5 hours straight. Haven't eaten since 8am (5.5 hours ago), haven't drunk water in 4 hours, haven't moved from chair in 4+ hours, missed noon medication, and have a meeting in 30 minutes. Your brain says 'just finish this function'.",
      action: "Input activity: coding, duration: 4.5 hours, missed needs: food/water/medication, upcoming: meeting in 30 min.",
      result: "LEVEL 3 FORCEFUL INTERRUPTION. Screen overlay: 'STOP. You have not eaten in 5.5 hours, missed medication, haven't moved in 4+ hours, AND meeting in 30 min. Get up NOW.' Mandatory checklist (cannot dismiss): ☐ Stand up and walk to kitchen ☐ Drink 16oz water ☐ Eat something with protein ☐ Take medication ☐ Stretch 2 minutes ☐ Check meeting time. Why this matters: You're dehydrated, hungry, haven't moved. This isn't sustainable productivity—it's harmful."
    },
    
    tips: [
      "Set this up BEFORE starting hyperfocus-prone activities",
      "The mandatory checklist exists because 'just 5 more minutes' turns into hours",
      "Level 3 interruptions should be physically impossible to ignore (screen overlay)",
      "After break, you CAN return to work - the goal isn't to stop working, it's to prevent harm",
      "If you keep hitting override, ask why you're avoiding basic needs"
    ],
    
    pitfalls: [
      "Don't dismiss Level 2/3 interruptions thinking you'll 'just remember later' - you won't",
      "Override function is for true emergencies only (production bug, absolute deadline)",
      "Using override means mandatory longer break afterward - you're accruing debt"
    ]
  }
},
...
{
  id: "ChoiceParalyzerHelper",
  title: "Choice Paralyzer Helper",
  category: "Mind & Energy",
  icon: "🎯",
  description: "Makes decisions FOR you when overwhelmed. Apply pre-loaded preferences to choose FOR you, not give you options. For choice paralysis - removes decision fatigue while respecting your values. Single answer, no second-guessing.",
  tagline: "Decisions made for you when you're overwhelmed",
  ...
  guide: {
    ...
    howToUse: [
      ...
      "Add your preferences/constraints (dietary, budget, energy, mood)",
      "Set capacity level (overwhelmed/low/medium)",
      "Get ONE decision with execution steps",
      "Follow the 'no second-guessing' instruction"
    ],
    ...
    example: {
      ...
      result: "DECISION: Order veggie burrito bowl from Chipotle. Why: Meets all constraints - vegetarian, no dairy (skip cheese/sour cream), under $15, delivery (no cooking), comfort food, customizable to avoid spice. Steps: 1. Open Chipotle app, 2. Order burrito bowl with brown rice, black beans, veggies, guac, lettuce, salsa (skip cheese and sour cream), 3. Delivery, 4. Submit. DONE. This choice is FINAL. Don't reconsider. Don't browse menus. You have limited decision capacity right now - this was decided using your preferences, and it's a good choice."
    },
...
},
{
  ...
  category: "Mind & Energy",
  icon: "🔄",
  description: "Your routine just broke — sick day, bad sleep, kid home, house guests, mental health day, pain flare, travel, power outage, partner away. Pick what happened and your energy level, get a complete adapted day: self-care anchors, time-blocked schedule with keep/simplify/drop for every task, copy-pasteable scripts for what to tell people, specific permissions to let things go, and a phased re-entry plan so you don't crash going back to 100%.",
  tagline: "Your routine broke. Here is your temporary replacement.",
  
  guide: {
    overview: "For routine-dependent people (ADHD, autism, anxiety, chronic illness, or just anyone whose day falls apart when the structure breaks), a disrupted routine cascades fast. This tool doesn't try to maintain your old routine — it builds a NEW temporary structure that accounts for today's reality. Pick from 15 disruption types, set your energy level (survival through near-normal), describe your normal routine and non-negotiables, and get back: self-care anchors (water, food, meds — concrete, not vague), a time-blocked adapted schedule where every task is tagged keep/simplify/drop, a summary grid, copy-pasteable scripts for boss/family/anyone asking, specific permission statements ('You do not need to cook today. Cereal is dinner.'), watch-for signs, and a 3-phase re-entry plan.",
    
    howToUse: [
      "Pick what happened: 15 disruption types from sick day to power outage to kid home unexpectedly",
      "Set your energy level: Survival (bare minimum), Low (essentials), Moderate (modified), Near-normal",
      "Set how long this will last: few hours to ongoing",
      "Describe your normal routine (optional but helps the AI adapt specifically)",
      "List non-negotiables: medication, feed pets, pick up kids, work deadline",
      "List constraints: can't leave house, no car, limited energy",
      "Get your adapted day with self-care anchors, time blocks, keep/simplify/drop triage",
      "Copy the 'what to tell people' scripts and send them",
      "Read the permissions section when guilt hits",
      "Use the re-entry plan when you're ready to go back to normal"
    ],
    
    example: {
      scenario: "You got almost no sleep last night. You have a normal 9-5 workday, gym after work, and need to cook dinner. Your energy is LOW. You have medication to take and a work standup at 10am you can't miss.",
      action: "Disruption: Bad sleep. Energy: Low. Duration: Today only. Routine: 'Wake 7am, gym 6:30am, work 9-5, cook dinner, bed 11pm'. Non-negotiables: 'Medication, 10am standup'. Constraints: 'Very tired, poor focus'.",
      result: "Self-care anchors: Take meds, drink water NOW, eat something before 10am. Adapted schedule: Morning — skip gym (drop), eat simple breakfast (simplified), shower optional (drop). Work — attend standup (keep), do only urgent tasks (simplified), take breaks every 45 min (added). Evening — order food or make toast (simplified from cooking), no screen time after 9pm (added), bed by 9:30 (earlier). Scripts: To boss: 'Running on low sleep today, will be less responsive but covering essentials.' Permissions: 'Skipping the gym today is not failure. It is the correct decision.' Re-entry: Phase 1 tomorrow — add back work focus. Phase 2 day after — add gym back. Phase 3 — full routine."
    },
    
    tips: [
      "Be honest about energy. Saying 'moderate' when you're at survival causes the adapted plan to be too ambitious.",
      "The self-care anchors are non-negotiable even in survival mode. Water, food, meds.",
      "Copy the 'what to tell people' scripts immediately. Writing explanations while dysregulated is exhausting.",
      "The permissions section exists for the guilt. Read it when you feel bad about dropping things.",
      "Don't go from adapted back to 100% in one day. Use the phased re-entry. Crashes happen from bouncing back too fast."
    ],
    
    pitfalls: [
      "Don't try to maintain your full routine during a disruption — that's how you crash harder",
      "Don't feel guilty about dropped tasks — they're explicitly marked as safe to skip",
      "Don't skip the re-entry plan — going 0 to 100 causes a second crash"
    ]
  },
  
  keywords: [
    "routine", "disruption", "sick", "schedule", "broken", "adapt",
    "structure", "energy", "survival", "sleep", "insomnia", "travel",
    "emergency", "ADHD", "autism", "chronic illness", "pain", "flare"
  ],
  
  tags: ["Mind & Energy", "Routine", "Accessibility", "Self-Care"],
  difficulty: "easy",
},

{
  id: "BrainStateDJ",
  title: "Brain State DJ",
  category: "Productivity",
  icon: "🎧",
...
},
{
  ...
  category: "Productivity",
  icon: "🗡️",
  description: "Translate complex documents into 5th-grade reading level. Upload legal contracts, medical forms, technical manuals, or any confusing document and get a plain English translation that preserves all critical information.",
  tagline: "Translate complex documents into plain language",
  
  guide: {
    overview: "Jargon Assassin breaks down impenetrable documents into language anyone can understand. It translates legal contracts, medical forms, financial documents, technical manuals, and academic papers into clear, simple English while preserving every important detail. The tool highlights critical sections, flags red flags, defines technical terms, and provides a checklist of things to verify before signing or agreeing to anything.",
    
    howToUse: [
      "Select your document type (legal, medical, technical, financial, academic, or government)",
      "Upload a .txt file or paste the document text directly into the box",
      "Click 'Translate Document' and wait for the AI to process it (usually 10-30 seconds)",
      "Review the summary to understand what the document is asking you to do",
      "Use the tabs to switch between side-by-side view, translation only, or highlighted key sections"
    ],
    
    example: {
      scenario: "You receive a 12-page rental lease full of legal terms like 'lessor,' 'lessee,' 'indemnify,' and complex clauses about liability and termination.",
      action: "Select 'Legal Contract' as the document type, paste the lease text, and click translate.",
      result: "You get: (1) A summary: 'This document is a rental agreement where you agree to rent an apartment for $2,000/month with specific rules about pets, noise, and early termination.' (2) Plain English translation replacing 'lessor' with 'landlord' and breaking complex sentences into simple ones. (3) Highlighted red flags like 'This clause makes you responsible for all repairs, which is unusual.' (4) A checklist: 'Before you sign, verify: security deposit amount, pet policy, early termination fees.'"
    },
    
    tips: [
      "The side-by-side view helps you compare original text with the translation to ensure nothing was lost",
      "Pay special attention to sections flagged as 'red flags'—these are unusual or potentially concerning clauses",
      "Use the glossary to understand technical terms you'll encounter again",
      "Adjust text size for easier reading, especially on mobile devices",
      "The checklist is crucial—work through it before signing anything"
    ],
    
    pitfalls: [
      "This tool simplifies language but cannot provide legal advice—if stakes are high, consult a professional",
      "Very long documents (50+ pages) may take longer to process and might need to be split into sections",
      "The tool preserves meaning but some nuance may be lost in translation—when in doubt about critical details, ask an expert"
    ]
  }
},
{
 ...
 ]}},
 {
  ...
  
  {
    ...
    category: "Academic",
    icon: "🛠️",
    description: "Explains syntax errors in plain English and suggests fixes.",
    tagline: "Plain English explanations for syntax errors",
    
    guide: {
      overview: "CodeFix takes cryptic compiler errors and translates them into plain English explanations. It shows exactly what's wrong, why it's wrong, and how to fix it - perfect for beginners learning to code.",
      
      howToUse: [
        "Paste your error message (or take a screenshot)",
        "CodeFix identifies the error type",
        "Read the plain English explanation",
        "See suggested fixes with code examples",
        "Apply the fix and try again"
      ],
      
      example: "'NullPointerException at line 23' → CodeFix explains: 'You're trying to use a variable that doesn't exist yet. You need to initialize it before line 23. Try: int count = 0;'",
      
      tips: [
        "Read the explanation to learn, don't just copy the fix",
        "Common errors get saved to your 'errors I've solved' list"
      ]
    }
  },
  
  {
    ...
    category: "Academic",
    icon: "📚",
    description: "Speed reading trainer that flashes words to eliminate eye movement.",
    tagline: "Train faster reading by eliminating eye movement",
    
    guide: {
      overview: "Speed Reader trains you to read faster by flashing words one at a time in the center of the screen, eliminating eye movement and forcing your brain to process faster. Gradually increase speed to build reading speed.",
      
      howToUse: [
        "Paste the text you want to read",
        "Set starting speed (200 words/min for beginners)",
        "Watch words flash in the center of the screen",
        "Focus on comprehension, not just speed",
        "Gradually increase speed each session"
      ],
      
      tips: [
        "Start slow - 200 wpm even if you can read faster normally",
        "Practice 10 minutes daily for 2 weeks to see improvement",
        "Take a comprehension quiz after to verify you're actually absorbing"
      ]
    }
  },
  {
...
},
{
    ...
    category: "Daily Life",
    icon: "🏦",
    description: "Timestamps apartment photos to prove damage existed before you moved in.",
    tagline: "Timestamp apartment damage before you move in",
    
    guide: {
      overview: "TheDeposit creates timestamped, cryptographically verified photos of your apartment when you move in. Landlords can't claim YOU caused pre-existing damage when you have irrefutable proof.",
      
      howToUse: [
        "On move-in day, take photos of EVERYTHING (walls, floors, appliances, fixtures)",
        "Focus on any existing damage, stains, scratches",
        "TheDeposit timestamps and securely stores the photos",
        "When you move out, compare to move-in photos",
        "Submit proof of pre-existing damage to dispute unfair charges"
      ],
      
      tips: [
        "Photograph EVERY room, closet, and corner",
        "Take close-ups of any damage, even small scratches",
        "Do this before unpacking anything",
        "Keep photos for the entire duration of your lease"
      ]
    }
  },
  {
