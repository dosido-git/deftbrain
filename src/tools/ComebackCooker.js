...
const EXAMPLES = [
  ...
  {
  situation: 'A project channel at work',
  whatTheySaid: "Well, that's one way to do it. I would have just done it properly the first time.",
...
const ComebackCooker = ({ tool }) => {
  ...
  const loadExample = useCallback(() => {
    const ex = pickExample('ComebackCooker', EXAMPLES);
    setSituation(ex.situation);
    setWhatTheySaid(ex.whatTheySaid);
