...
const PlotTwist = ({ tool }) => {
  ...
  const renderInput = () => (
    <div className="space-y-4">
      ...
      {/* Options */}
      <div className={`${c.card} border rounded-xl p-5`}>
        <label className={`text-xs font-bold ${c.textSecondary} uppercase tracking-wide mb-2 block`}>🔀 Your options</label>
      ...
      {/* Values */}
      <div className={`${c.card} border rounded-xl p-5`}>
        <label className={`text-xs font-bold ${c.textSecondary} uppercase tracking-wide mb-1 block`}>💎 What matters most?</label>
      ...
      {/* Why stuck */}
      <div className={`${c.card} border rounded-xl p-5`}>
        <label className={`text-xs font-bold ${c.textSecondary} uppercase tracking-wide mb-2 block`}>🧠 Why are you stuck?</label>
        <div className="flex flex-wrap gap-1.5">
      ...
      <div className={`${c.card} border rounded-xl p-5 space-y-3`}>
        <div>
          <label className={`text-xs font-bold ${c.textSecondary} uppercase tracking-wide mb-1 block`}>💬 Extra context</label>
        ...
        <div>
          <label className={`text-xs font-bold ${c.textSecondary} uppercase tracking-wide mb-1 block`}>⏰ Deadline</label>
