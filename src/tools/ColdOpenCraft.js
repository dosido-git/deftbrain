...
const EXAMPLE = {
  who: 'A senior engineering manager at Stripe whose Substack on on-call rotations I follow',
  why: 'Open conversation about a Staff Engineer role she posted about last week',
  channel: 'email',
  whatYouKnow: 'She wrote a thoughtful piece on reducing pager fatigue. Worked at Square before Stripe. Comments occasionally on Twitter about backend reliability — friendly tone.',
  yourBackground: "8 years backend at fintech startups (Plaid, Brex), currently tech-leading a 6-person team. Shipped a real-time risk system handling 50M events/day.",
  tone: 'medium',
};
const CHANNELS = [
...
const ColdOpenCraft = ({ tool }) => {
  ...
  const loadExample = useCallback(() => {
    ...
    setWhatYouKnow(EXAMPLE.whatYouKnow);
    setYourBackground(EXAMPLE.yourBackground);
    setTone(EXAMPLE.tone);
    setResults(null);
  }, [setWho, setWhy, setChannel, setWhatYouKnow, setYourBackground, setTone, setResults]);
