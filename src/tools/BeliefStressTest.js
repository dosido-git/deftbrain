...
const EXAMPLE = {
  ...
  context: 'Inherited from my parents — I apply it to my career, and use it to evaluate other people\'s effort. Lately wondering if it\'s held me back from quitting things that weren\'t working.',
};
