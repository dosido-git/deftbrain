...
<pre>${escaped}</pre>
  ...
  return (
    <div>
      ...
      {step === 1 && (
        <div className="space-y-4">
                    ...
                    <div className="flex items-start justify-between mb-2">
                      ...
                      <div className="flex gap-1.5">
                        <button
                          ...
                          className="flex items-center gap-1 px-2.5 py-1 rounded-lg text-xs font-bold bg-cyan-600 text-white hover:bg-cyan-700 transition-colors"
                        >
                          {copied.quickRights ? <span>✓</span> : null}
          ...
          <div className={`${c.card} border rounded-2xl shadow-lg p-4`}>
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-3 py-2 rounded-lg text-xs font-bold bg-cyan-600 text-white hover:bg-cyan-700 disabled:bg-zinc-300 disabled:text-zinc-500 dark:disabled:bg-zinc-600 transition-colors"
              >
          ...
          <div className="flex items-center justify-end">
            <button
              onClick={() => setStep(2)}
              className="flex items-center gap-2 px-6 py-3 rounded-xl font-bold text-white bg-cyan-600 hover:bg-cyan-700 transition-colors shadow-md shadow-teal-100 dark:shadow-none"
            >
        ...
        <div className={`${c.card} border rounded-2xl shadow-lg p-6 sm:p-8`}>
          ...
          <div className="mt-8 flex items-center justify-between">
            ...
            <button
              ...
              className="flex items-center gap-2 px-6 py-3 rounded-xl font-bold text-white bg-cyan-600 hover:bg-cyan-700 disabled:bg-zinc-300 disabled:text-zinc-500 dark:disabled:bg-zinc-600 dark:disabled:text-zinc-400 transition-colors shadow-md shadow-teal-100 dark:shadow-none"
            >
              {loading ? (
                <>
      ...
      {step === 3 && results && (
        <div className="space-y-4">
          <ActionBar content={''} title="Deposit Analysis" />
              ...
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="flex gap-1.5">
                  <button
                    ...
                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold bg-cyan-600 text-white hover:bg-cyan-700 transition-colors"
                  >
                    {copied.report ? <span>✓</span> : null}
