...
const MarkupDetective = ({ tool }) => {
  ...
  // ── PF-8: useRegisterActions (after buildCopyText) ──
  useRegisterActions(buildCopyText(), tool?.title || 'Markup Detective');
      ...
      <div className={`${c.card} border ${c.border} rounded-xl shadow-sm`}>
        ...
        <div className="px-5 pb-5 pt-4 space-y-4">
          ...
          <p className={`text-xs text-center ${c.textMuted}`}>
            Wondering if it's worth buying at all? Try <a href="/BuyWise" className={linkStyle}>🛒 BuyWise</a>.
          </p>
