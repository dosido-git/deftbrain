...
const TaskAvalancheBreaker = ({ tool }) => {
  ...
  // ─── Keep handleBreakDown ref fresh so keyboard handler never stales ───
      ...
      <div className={`${c.card} border ${c.border} rounded-xl shadow-lg p-6 transition-colors duration-200`}>
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className={`text-sm ${c.textMuted}`}>{tool?.tagline ?? 'Let\'s turn that mountain into micro-steps'}</p>
          </div>
        </div>
