...
import { ActionBar, PrintBtn } from '../components/ActionButtons';
      ...
      <div className={`${c.card} border ${c.border} rounded-xl shadow-lg p-6 transition-colors duration-200`}>
        ...
        <div className="space-y-6">
          ...
          <p className={`text-xs text-center ${c.textMuted}`}>
            ...
            <a href="brain-dump-structurer" target="_blank" rel="noopener noreferrer" className={linkStyle}>Brain Dump Structurer</a>{' '}
      ...
      {results && (
        <div ref={resultsRef} className="space-y-6">
          ...
          <div className={`${c.card} border ${c.border} rounded-xl p-4 flex gap-3 flex-wrap`}>
            ...
            <PrintBtn content={buildFullText()} title="Task Avalanche Plan" />
          </div>
          ...
          <div className="text-center space-y-2">
            <p className={`text-xs ${c.textMuted}`}>
              ...
              <a href="focus-pocus" target="_blank" rel="noopener noreferrer" className={linkStyle}>Focus Pocus</a>{' '}
              keeps you on track with timers and body check-ins.
            </p>
            {energy <= 3 && (
              <p className={`text-xs ${c.textMuted}`}>
                Feeling like everything is on fire?{' '}
                <a href="crisis-prioritizer" target="_blank" rel="noopener noreferrer" className={linkStyle}>Crisis Prioritizer</a>{' '}
