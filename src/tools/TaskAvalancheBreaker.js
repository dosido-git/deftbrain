      ...
      <div className={`${c.card} border ${c.border} rounded-xl shadow-sm`}>
            ...
            <div className="flex items-start justify-between gap-3">
              <div>
                ...
                <p className={`text-base ${c.textSecondary}`}>
                  <span className="me-2 text-lg">{tool?.icon ?? '⛏️'}</span>{tool?.tagline ?? t('tab_tagline')}
                </p>
        ...
        <div className="px-5 pb-5 pt-4 space-y-6">
          ...
          <div className="flex gap-3">
            <button title={t('cmd_enter')} onClick={handleBreakDown} disabled={loading || !canSubmitRef.current}
              className={`relative flex-1 ${(!canSubmitRef.current) ? c.btnIdle : c.btnPrimary} font-bold py-3 px-6 rounded-lg flex items-center justify-center gap-2 min-h-[48px]`}>
