            ...
            <div className="flex items-start justify-between gap-3">
              <div>
                <h2 className={`text-xl font-bold ${c.text}`}>
                  <span className="mr-2">{tool?.icon ?? '⛏️'}</span>{tool?.title ?? 'Task Avalanche Breaker'}
                </h2>
      ...
      <div className={`${c.card} border ${c.border} rounded-xl p-4 transition-colors duration-200`}>
        ...
        {shouldWarnAboutExport() && (
          <div className={`mt-3 p-3 rounded-lg border-2 ${c.infoBox}`}>
            <p className={`text-sm font-semibold`}>💾 Backup Reminder</p>
            <p className={`text-xs mt-1`}>
              {lastExportDate
        ...
        <div ref={resultsRef} className="space-y-6">
                    ...
                    <div className={`${c.card} rounded-lg p-5 mb-4`}>
                      ...
                      {task.why_this_first && (
                        <div className={`mb-3 p-3 rounded ${c.infoInnerBg}`}>
                          <p className={`text-sm ${c.infoInnerTxt}`}><strong>Why this first:</strong> {task.why_this_first}</p>
                        </div>
                      )}
                      {task.habit_stack && (
                        <div className={`mb-3 p-3 rounded ${c.cyanInnerBg}`}>
                          <p className={`text-sm ${c.cyanInnerTxt}`}><span>🔗</span> <strong>Habit stack:</strong> {task.habit_stack}</p>
                        </div>
                      )}
          ...
          <div className="text-center space-y-2">
            <p className={`text-xs ${c.textMuted}`}>
              ...
              <a href="/FocusPocus" className={linkStyle}>🎯 Focus Pocus</a>{' '}
