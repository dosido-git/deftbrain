...
const TheRunthrough = ({ tool }) => {
  ...
  const c = {
    ...
    btnAccent:       isDark ? 'bg-amber-600 hover:bg-amber-500 text-white' : 'bg-amber-500 hover:bg-amber-600 text-white',
    ...
    <div className={`min-h-screen ${c.cardAlt} transition-colors duration-200`}>
      <div className="max-w-2xl mx-auto px-4 py-8 space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <h1 className={`text-2xl font-bold ${c.text}`}>The Runthrough</h1>
        ...
        <div className={`${c.card} ${c.border} border rounded-2xl p-5 shadow-sm space-y-4`}>
          ...
          <button
            ...
            className={`w-full ${c.btnAccent} py-3 rounded-xl font-semibold text-sm shadow-md
