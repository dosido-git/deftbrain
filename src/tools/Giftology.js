      ...
      <div className={`${c.card} border ${c.border} rounded-xl shadow-lg p-5`}>
        ...
        <div className="mb-4">
          ...
          <div className="flex justify-between mt-1">
            <span className={`text-[10px] ${c.textMuteded}`}>Ctrl/Cmd+Enter to submit</span>
            <button onClick={loadExample} className={`text-[10px] ${c.textMuteded} hover:underline`}>
              🎲 Load example
            </button>
          </div>
        </div>
      ...
      {results && (
        <div ref={resultsRef} className="space-y-4">
          ...
          <div className="flex items-center justify-between gap-2">
            <button onClick={handleReset} className={`${c.btnSecondaryondary} px-4 py-2 rounded-lg text-sm font-bold flex items-center gap-1.5 min-h-[40px]`}>
              ↩ Start Over
            </button>
                    ...
                    >
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          <span className={`text-xs font-bold ${c.textMuteded}`}>#{i + 1}</span>
                          <h3 className={`text-sm font-bold ${c.text} truncate`}>{pick.gift}</h3>
                        </div>
                        <p className={`text-xs ${c.textMuteded}`}>{pick.price_range}</p>
                      </div>
                      <span className={`text-xs ${c.textMuteded} flex-shrink-0 mt-1`}>
                        {isExpanded ? '▲' : '▼'}
                      </span>
                    </button>
            ...
            <div>
              {!showWildcard ? (
                <button
                  ...
                  className={`w-full ${c.btnSecondaryondary} py-3 rounded-xl text-sm font-medium flex items-center justify-center gap-2`}
                >
          ...
          <div className="space-y-1.5">
            {history.map(entry => (
              <button key={entry.id}
                ...
                className={`w-full text-left px-3 py-2 rounded-lg ${c.btnSecondaryondary} text-xs flex items-center gap-2`}>
