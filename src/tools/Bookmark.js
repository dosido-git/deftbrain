...
// Example seeds — key-driven, resolved through t() in loadExample. Five per
// media type, rotated per type by pickExample: a precise stopping point, a
// vague one ("a third in", "maybe 30 runs"), one where nothing at all is
// remembered (no rememberKey), and titles that range from a tight plot to a
// season that is really a standings table.
const EXAMPLES = {
  show: [
    { titleKey: 'bk_ex_show_title', stoppedKey: 'bk_ex_show_stopped', rememberKey: 'bk_ex_show_remember' },
    { titleKey: 'bk_ex_show2_title', stoppedKey: 'bk_ex_show2_stopped' },
    { titleKey: 'bk_ex_show3_title', stoppedKey: 'bk_ex_show3_stopped', rememberKey: 'bk_ex_show3_remember' },
    { titleKey: 'bk_ex_show4_title', stoppedKey: 'bk_ex_show4_stopped', rememberKey: 'bk_ex_show4_remember' },
    { titleKey: 'bk_ex_show5_title', stoppedKey: 'bk_ex_show5_stopped', rememberKey: 'bk_ex_show5_remember' },
  ],
  book: [
    { titleKey: 'bk_ex_book_title', stoppedKey: 'bk_ex_book_stopped', rememberKey: 'bk_ex_book_remember' },
    { titleKey: 'bk_ex_book2_title', stoppedKey: 'bk_ex_book2_stopped', rememberKey: 'bk_ex_book2_remember' },
    { titleKey: 'bk_ex_book3_title', stoppedKey: 'bk_ex_book3_stopped' },
    { titleKey: 'bk_ex_book4_title', stoppedKey: 'bk_ex_book4_stopped', rememberKey: 'bk_ex_book4_remember' },
    { titleKey: 'bk_ex_book5_title', stoppedKey: 'bk_ex_book5_stopped', rememberKey: 'bk_ex_book5_remember' },
  ],
  game: [
    { titleKey: 'bk_ex_game_title', stoppedKey: 'bk_ex_game_stopped', rememberKey: 'bk_ex_game_remember' },
    { titleKey: 'bk_ex_game2_title', stoppedKey: 'bk_ex_game2_stopped', rememberKey: 'bk_ex_game2_remember' },
    { titleKey: 'bk_ex_game3_title', stoppedKey: 'bk_ex_game3_stopped' },
    { titleKey: 'bk_ex_game4_title', stoppedKey: 'bk_ex_game4_stopped', rememberKey: 'bk_ex_game4_remember' },
    { titleKey: 'bk_ex_game5_title', stoppedKey: 'bk_ex_game5_stopped', rememberKey: 'bk_ex_game5_remember' },
  ],
  sports: [
    { titleKey: 'bk_ex_sports_title', stoppedKey: 'bk_ex_sports_stopped', rememberKey: 'bk_ex_sports_remember' },
    { titleKey: 'bk_ex_sports2_title', stoppedKey: 'bk_ex_sports2_stopped', rememberKey: 'bk_ex_sports2_remember' },
    { titleKey: 'bk_ex_sports3_title', stoppedKey: 'bk_ex_sports3_stopped' },
    { titleKey: 'bk_ex_sports4_title', stoppedKey: 'bk_ex_sports4_stopped', rememberKey: 'bk_ex_sports4_remember' },
    { titleKey: 'bk_ex_sports5_title', stoppedKey: 'bk_ex_sports5_stopped', rememberKey: 'bk_ex_sports5_remember' },
  ],
};
...
const Bookmark = ({ tool }) => {
  ...
  const loadExample = useCallback(() => {
    const ex = EXAMPLES[mediaType] ? pickExample(`Bookmark:${mediaType}`, EXAMPLES[mediaType]) : null;
