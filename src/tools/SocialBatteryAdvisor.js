...
const SocialBatteryAdvisor = ({ tool }) => {
  ...
  // Scroll to (and focus) the pattern analysis when it arrives — otherwise
  // focus stays on the "Look for Patterns" button, which `loading` disabled
  // and the browser blurred to <body> the instant that happened.
