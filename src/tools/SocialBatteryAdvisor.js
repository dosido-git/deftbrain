      ...
      <div className={`${c.card} border rounded-xl p-5`}>
        ...
        <div className="flex gap-2">
          <button title={t('cmd_enter')}
            ...
            className={`relative flex-1 ${(!interactions.some(i => i.situation.trim())) ? c.btnIdle : c.btnPrimary} font-bold py-3 rounded-lg flex items-center justify-center gap-2 min-h-[48px]`}
          >
            {loading
