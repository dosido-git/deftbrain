...
// Five, rotated across relationships, resistance levels and goal
// combinations: a raise ask, an overdue loan boundary, an unrepaired
// lease, feedback to a struggling coworker, and retiring from being an
// adult child's safety net.
const EXAMPLES = [
  {
  ...
  {
  topic: "Telling my landlord the repairs he promised three months ago still haven't happened, and I'm considering withholding rent.",
  relationship: 'Landlord',
  communicationStyle: 'Firm',
  resistanceLevel: 70,
  goals: ['requestChange', 'sayNo'],
  fears: ['retaliate', 'deny'],
  biggestFear: "He'll find a reason to not renew my lease instead of fixing anything.",
  theirPerspective: "He probably thinks I'm exaggerating how bad it is, since I've been polite about it every time so far.",
  previousAttempts: "Three texts, all answered with 'will get someone out there soon,' no one has ever come.",
},
  {
  topic: "Giving feedback to a coworker whose part of a shared project keeps arriving late and unfinished, making me look bad to our shared manager.",
  relationship: 'Coworker',
  communicationStyle: 'Collaborative',
  resistanceLevel: 40,
  goals: ['giveFeedback'],
  fears: ['damage', 'cry'],
  biggestFear: "It comes across as an attack and we can't work together comfortably afterward.",
  theirPerspective: "They might be drowning in something I don't know about and have no idea it's visibly affecting me.",
  previousAttempts: "Covered for them twice without saying anything, which probably just taught them it's fine.",
},
  {
  topic: "Telling my adult child I can no longer lend money for rent every month — I need to actually retire.",
  relationship: 'Other',
  communicationStyle: 'Gentle',
  resistanceLevel: 55,
  goals: ['setBoundary', 'sayNo'],
  fears: ['guilt', 'damage', 'retaliate'],
  biggestFear: "That they'll see it as abandonment at the exact moment they need me most.",
  theirPerspective: "They probably assume the money is easier for me than it actually is, because I've never said otherwise.",
  previousAttempts: "Have quietly reduced the amount twice without ever explaining why.",
},
];
