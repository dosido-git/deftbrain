...
const RoommateCourt = ({ tool }) => {
  ...
  const loadExample = useCallback(() => {
    ...
    setDispute(EXAMPLE.dispute);
    setYourSide(EXAMPLE.yourSide);
    setTheirSide(EXAMPLE.theirSide);
    setDuration(EXAMPLE.duration);
    setPriorComm(EXAMPLE.priorComm);
    setLivingSituation(EXAMPLE.livingSituation);
