      ...
      {(disputeResult || assignResult) && (
        <div className={`${c.cardAlt} border ${c.border} rounded-xl p-4`}>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <a href="/RulebookBreaker"    className={`text-xs ${linkStyle}`}>🏴‍☠️ {t('rc_rulebook_breaker')}</a>
          </div>
        </div>
      )}
