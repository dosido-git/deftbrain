        ...
        <div className="pb-3 border-b border-zinc-500 flex items-center justify-between">
          <div>
            <h2 className={`text-xl font-bold ${c.text}`}>
              <span className="me-2">{tool?.icon ?? '🎫'}</span>{tool?.title ?? t('tt_title')}
            </h2>
            <p className={`text-sm ${c.textSecondary}`}>{tool?.tagline ?? t('tt_tagline')}</p>
            <button
              onClick={loadExample}
              disabled={loading}
