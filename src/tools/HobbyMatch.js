...
const EXAMPLE = {
  personality: "Introvert, low-key competitive, gets bored fast with anything routine. Loves learning new things but hates being a beginner in public. Thinks too much, would benefit from getting out of my head.",
  schedule: 'Weekday evenings (after 7pm), random 30-minute gaps during the day, occasional weekend afternoons',
  budget: '$50-100/month',
  physical: 'Generally fit but bad knees — limit on running and jumping. Anything seated or low-impact is fine.',
  triedBefore: 'Tried yoga (boring), guitar (gave up after a month), running (knees), chess (loved it but plateaued)',
  selectedGoals: ['quiet_time', 'learn_skill', 'creative_outlet'],
};
const BUDGET_LEVELS = [
    ...
    <div className={`space-y-4 ${c.text}`}>
      ...
      <div className={`${c.card} border ${c.border} rounded-xl p-6`}>
        ...
        <p className={`text-xs ${c.textMuted} mb-4`}>
          Not sure what energizes you? <a href="/BrainDumpBuddy" className={linkStyle}>🧠 Brain Dump Buddy</a> helps you list what you actually love first.
        </p>
