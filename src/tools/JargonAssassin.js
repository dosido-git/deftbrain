    ...
    <div className={`space-y-4 ${c.text}`}>
      ...
      {mode === 'letter' && <div className="space-y-4">
        ...
        {ltrData && <div className="space-y-3">
          ...
          <div className={`${c.card} ${c.border} border ${c.border} rounded-xl p-5`}><div className="flex justify-between mb-2"><h3 className={`font-bold ${c.text}`}>Your Letter</h3></div><p className={`text-sm ${c.textSecondary} whitespace-pre-line`}>{ltrData.letter}</p></div>
