  ...
  const renderInput = () => (
    <div className="space-y-4">
      ...
      <div className={c.card + ' border rounded-xl p-5'}>
        ...
        {batchMode ? (
          <>
            <label className={`text-xs font-bold ${c.labelText} block mb-1.5`}>Words to pronounce <span className={c.required}>*</span></label>
          ...
          <>
            <label className={`text-xs font-bold ${c.labelText} block mb-1.5`}>Word to pronounce <span className={c.required}>*</span></label>
      ...
      <p className={`text-[11px] ${c.textMuted} text-center`}>
        Long technical document with names you don't know? <a href="/PlainTalk" className={linkStyle}>📄 PlainTalk</a> can identify them all in one pass.
      </p>
      ...
      <div ref={resultsRef} className="space-y-4 mt-4">
        ...
        <div className={`${c.cardAlt} border ${c.border} rounded-xl p-4`}>
          ...
          <p className={`text-xs ${c.textSecondary}`}>
            Practicing for a meeting where this comes up? <a href="/NerveCheck" className={linkStyle}>💪 NerveCheck</a> turns nerves into a script.
          </p>
        </div>
