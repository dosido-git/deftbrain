...
const EXAMPLE = {
  imageDescription: 'Golden hour shot of my dog mid-leap catching a frisbee at the beach, sand spraying everywhere, ocean blurred in the background',
  context: 'Posting to Instagram — building a feed around outdoor adventures with my rescue dog Max',
  useBrandVoice: false,
};
// ════════════════════════════════════════════════════════════
// CONSTANTS
...
const CaptionMagic = ({ tool }) => {
  ...
  const loadExample = useCallback(() => {
    ...
    setUseBrandVoice(EXAMPLE.useBrandVoice);
    setResults(null);
  }, [setImageDescription, setContext, setUseBrandVoice, setResults]);
