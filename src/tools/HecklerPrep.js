...
const EXAMPLE = {
  topic: 'Q3 security budget increase',
  audience: 'C-suite executives — CFO, COO, and CTO',
  proposal: 'Increase our security tooling and headcount budget by 40% next quarter ($1.2M total) to address the gaps surfaced in the recent pen test.',
  knownObjections: "They'll push on: why now, why this much, why we didn't catch it earlier, whether we explored cheaper alternatives, and what the ROI looks like in 12 months.",
  stakes: 'high',
};
const STAKES_LEVELS = [
      ...
      <div className={`${c.card} border ${c.border} rounded-xl p-6`}>
        <div className="mb-5 pb-4 border-b border-zinc-500 flex items-start justify-between gap-3">
          <div>
            <h2 className={`text-xl font-bold ${c.text}`}>
              <span className="mr-2">{tool?.icon ?? '🎤'}</span>{tool?.title ?? 'Heckler Prep'}
            </h2>
        ...
        <div className="mb-4">
          <p className={`text-xs ${c.textMuted} mb-2`}>
            Open strong first — <a href="/ColdOpenCraft" className={linkStyle}>📬 Cold Open Craft</a> sharpens your first 90 seconds before you handle the heckling.
          </p>
