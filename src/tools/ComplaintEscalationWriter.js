                  ...
                  <div className={`p-3 rounded-xl border ${recoBg[responseAnalysis.recommendation] || recoDefault}`}>
                    <div className="flex items-center gap-2 mb-2">
                      <span className={`px-2 py-0.5 rounded-full text-[10px] font-bold ${recoBadge[responseAnalysis.recommendation] || recoBadgeDefault}`}>
                        {responseAnalysis.recommendation === 'accept' ? '✅ Accept' : responseAnalysis.recommendation === 'counter' ? '🤝 Counter' : responseAnalysis.recommendation === 'escalate' ? '⬆️ Escalate' : <><span className="inline-block animate-spin">{tool?.icon ?? '📧'}</span> Wait</>}
                      </span>
