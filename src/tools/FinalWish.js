...
const EXAMPLE = {
  ...
  accounts: [
    { id: 'acc_1', name: 'Apple iCloud', type: 'cloud_storage', notes: 'Photos and personal documents — Jordan has the recovery key in the fireproof safe.' },
    { id: 'acc_2', name: 'Gmail (alex.rivera@gmail.com)', type: 'email', notes: '2FA via Authenticator app on phone. Backup codes in the safe envelope marked GMAIL.' },
    { id: 'acc_3', name: '1Password', type: 'password_manager', notes: "Master password is in the sealed envelope in Jordan's filing cabinet, top drawer. Has access to most other accounts." },
  ],
  financialAccounts: [
    { id: 'fin_1', institution: 'Wells Fargo', type: 'checking', notes: 'Primary checking. Auto-pays for utilities and rent.' },
    { id: 'fin_2', institution: 'Vanguard', type: 'retirement', notes: '401(k) and Roth IRA. Beneficiary is Jordan (updated 2024).' },
    { id: 'fin_3', institution: 'Fidelity', type: 'brokerage', notes: 'Taxable account. Statements come quarterly to my email.' },
  ],
  ...
  pets: [
    { id: 'pet_1', name: 'Miso', species: 'cat', age: '7', notes: "Indoor cat, mostly chill. Eats Hill's i/d for sensitive stomach. Vet is Dr. Kim at Mission Pet Hospital. Sam has agreed to take her if needed and she already knows them." },
  ],
...
const FinalWish = ({ tool }) => {
  ...
  }, [setUserName, setTrustedPeople, setAccounts, setFinancialAccounts, setRecurringBills, setPets, setHomeNotes, setDeviceNotes, setMemorialWishes, setSpecialRequests, setEmergencyContacts, setMessages, setPassphraseHint]);
