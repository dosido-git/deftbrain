    ...
    <div className={`space-y-4 ${c.text}`}>
      ...
      <div className={`${c.card} border rounded-xl p-5`}>
        <div className={`mb-4 pb-3 border-b ${isDark ? 'border-zinc-500' : 'border-zinc-500'}`}>
          ...
          <p className={`text-sm ${c.textSecondary}`}>Ask any question — get a confidently, beautifully wrong answer</p>
        </div>
        ...
        <div className="space-y-4">
          ...
          {results.question_rephrased && (
            <div className={`${c.infoBox} border-2 rounded-xl p-5`}>
              <p className={`text-xs ${c.textMuteded} mb-1`}>You asked:</p>
              ...
              <div className="space-y-2">
                {results.supporting_evidence.map((e, i) => (
                  <div key={i} className={`${c.quoteBg} rounded-lg p-3`}>
                    ...
                    <p className={`text-[10px] ${c.textMuteded} italic`}>— {e.fake_source}</p>
          ...
          {results.common_misconception && (
            <div className={`${c.warning} border rounded-xl p-4`}>
              ...
              <p className={`text-[9px] ${c.textMuteded} mt-1 italic`}>(This is probably the actual answer)</p>
            </div>
          )}
      ...
      <div className={`${c.cardAlt} border ${c.border} rounded-xl p-4 mt-2`}>
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <a href="/tool/what-if-machine" className={`text-xs ${linkStyle}`}>🤔 What-If Machine</a>
