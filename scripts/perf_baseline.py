...
TOOL_IDS = [
    ...
    'LeaseTrapDetector', 'LeverageLogic', 'LuckSurface',
    ...
    'PreMortem', 'ProcedureProbe', 'PronounceItRight', 'TheCrux',
...
PAYLOADS = {
    ...
    'TheCrux': {'transcript': 'Mitochondria are membrane-bound organelles that produce ATP through cellular respiration. They have a double membrane structure and contain their own DNA.', 'subject': 'Biology', 'lectureTitle': 'Cell organelles'},
