...
- deftbrain_next — what each id is for: ChaosPilot (too many urgent things at once), GriefGuide (loss), SleepArchitect (not sleeping), BrainStateDeejay (cannot settle or focus), BeforeTheCrash (heading for burnout), SocialBatteryAdvisor (people are draining), NerveCheck (one specific dreaded event).
