...
// ═══════════════════════════════════════════════════
//  POST /wardrobe-chaos-resolver — Main outfit gen
// ═══════════════════════════════════════════════════
router.post('/wardrobe-chaos-resolver', rateLimit(DEFAULT_LIMITS), async (req, res) => {
  try {
...
// ═══════════════════════════════════════════════════
//  POST /wardrobe-chaos-resolver/regenerate — Swap piece or regenerate
// ═══════════════════════════════════════════════════
router.post('/wardrobe-chaos-resolver/regenerate', rateLimit(DEFAULT_LIMITS), async (req, res) => {
  try {
...
// ═══════════════════════════════════════════════════
//  POST /wardrobe-chaos-resolver/pack — Packing list generator
// ═══════════════════════════════════════════════════
router.post('/wardrobe-chaos-resolver/pack', rateLimit(DEFAULT_LIMITS), async (req, res) => {
  try {
