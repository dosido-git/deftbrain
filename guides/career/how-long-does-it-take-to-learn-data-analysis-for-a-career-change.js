// ============================================================
// guides/career/how-long-does-it-take-to-learn-data-analysis-for-a-career-change.js
// ============================================================

module.exports = {
  slug:          'how-long-does-it-take-to-learn-data-analysis-for-a-career-change',
  category:      'career',
  categoryLabel: 'Career',

  title:         "How Long Does It Take to Learn Data Analysis for a Career Change?",
  titleHtml:     "How Long Does It Take to <em>Learn Data Analysis for a Career Change?</em>",
  ...
  cta: {
    glyph:    '🗺',
    headline: "Get your specific timeline based on where you are",
    body:     "Skill Gap Map analyzes your starting point, target role, and available study time, then produces a personalized timeline — by skill, by milestone, with a specific portfolio plan and interview-ramp schedule.",
    features: [
      "Starting-point audit",
      "Personalized timeline estimate",
      "Tool-vs-thinking breakdown",
      "Portfolio project plan",
      "Entry-role recommendations",
    ],
    toolId:   'SkillGapMap',
