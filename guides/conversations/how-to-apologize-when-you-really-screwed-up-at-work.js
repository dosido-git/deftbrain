module.exports = {
  ...
  title:         "How to Apologize When You Really Screwed Up at Work",
  titleHtml:     "How to Apologize When You <em>Really</em> Screwed Up at Work",
  shortTitle:    "Apologize for a Major Work Mistake",
  navTitle:      "apologize when you really screwed up at work",
  description:   "A level-5 work apology has four parts: own it, name the harm, commit to the fix, accept consequences. No defense, no excuses, no blame.",
  deck:          "A level-5 work apology has four parts: own it, name the harm, commit to the fix, accept consequences. No defense, no excuses, no blame.",
  ledes: [
