module.exports = {
  slug:          'how-to-steelman-an-argument-you-disagree-with',
  category:      'conversations',
  categoryLabel: 'Conversations',
  title:         "How to steelman an argument you disagree with",
  titleHtml:     "How to steelman an argument you disagree with",
  shortTitle:    "Steelman an argument",
  navTitle:      "Steelman an argument",
  description:   "You can demolish their dumbest version. Anyone can. Here is how to find and engage with the strongest version of the position you think is wrong.",
  ...
  steps: [
    ...
    { name: `Identify the value underneath the position, not just the position`, body: `Most disagreements are not actually about the surface claim. They are about which value gets weighted higher when values conflict. Liberty vs. safety. Tradition vs. progress. Group cohesion vs. individual autonomy. If you can name the value that their position is protecting, you stop arguing past each other. You also realize that you probably hold that value too, just at a different weight, which is a much more honest starting point for actually changing anyone's mind, including your own.` },
    { name: `State their case out loud without any hedge words`, body: `No "I guess they would say." No "the most charitable reading might be." Just say their position the way they would say it, with their conviction, in language they would use. If saying it makes you uncomfortable, that is the right discomfort. You are practicing inhabiting a view you do not hold, which is the only way to know whether you actually disagree with it or whether you have been disagreeing with a cartoon of it.` },
    { name: `Find the part of their case you cannot easily refute, and sit with it`, body: `Inside every steelman there will be one piece that is genuinely hard to argue against. Find it. Do not dismiss it. Do not flip back to the easy parts. The strongest version of any opposing position contains at least one true thing. The discipline is to admit which true thing it is — even just to yourself — before you go back to defending your own view. Most people skip this step, which is why most disagreements never actually move.` },
    { name: `Engage their best, not their worst, when you finally make your case`, body: `When it is your turn to push back, push back on the steelman, not on the version they would never claim. "I hear that the strongest case for this is X, and the part I find hardest to refute is Y. Where I still land differently is..." This is the move that changes minds, including the minds of people watching the conversation. Refuting the worst version of someone makes you feel right. Refuting the best version of them makes you persuasive.` }
  ],
  cta: {
    glyph:    '🥊',
