module.exports = {
  slug:          'how-to-think-through-a-job-offer-when-youre-torn',
  category:      'decisions',
  categoryLabel: 'Decisions',
  title:         "How to think through a job offer when you're torn",
  ...
  cta: {
    ...
    body:     "Which Life? doesn't list pros and cons — describe taking the offer and describe staying put, and it writes a vivid 'day in the life' for each, a plausible workday Tuesday set in each future, so your gut reacts before your brain does.",
    features: [
