module.exports = {
  slug:          'how-to-stop-paying-for-subscriptions-you-forgot-about',
  category:      'money',
  categoryLabel: 'Money',

  title:         "How to Stop Paying for Subscriptions You Forgot About (And Find the Ones Hiding on Your Card)",
  titleHtml:     "How to Stop Paying for Subscriptions You Forgot About <em>(And Find the Ones Hiding on Your Card)</em>",
  shortTitle:    "How to Stop Paying for Subscriptions You Forgot About",
  navTitle:      "How to stop paying for subscriptions you forgot about and find the ones hiding on your card",

  description:   "The average household has 3-5 active subscriptions they don't remember signing up for. Finding them is mechanical. Canceling them is the easy part — once you know where to look.",
  deck:          "The average household has 3-5 active subscriptions they don't remember signing up for. Finding them is mechanical. Canceling them is the easy part — once you know where to look.",
  ...
  steps: [
    {
      name: "Audit twelve months of statements, not one",
