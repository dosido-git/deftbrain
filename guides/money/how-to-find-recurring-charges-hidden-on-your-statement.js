module.exports = {
  ...
  ledes: [
    ...
    `Here is how to trace them — and how Subscription Slayer names them for you.`,
  ],
  steps: [
    ...
    { name: 'Use Subscription Slayer to identify and decode them automatically', body: 'Drop the statement into Subscription Slayer and it decodes processor prefixes and obscure merchant strings to actual service names. It maintains a database of these mappings and updates it as new ones appear. The line item that said \'DRI*BLZ MERCHANT\' becomes \'Blizzard Battle.net subscription\' with a link to your account page. From cryptic to actionable in seconds.' }
  ],
  cta: {
    glyph:    '⚔️',
