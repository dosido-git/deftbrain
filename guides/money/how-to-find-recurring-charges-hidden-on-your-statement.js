module.exports = {
  ...
  ledes: [
    ...
    `Here is how to trace them — and how Subscription Tamer names them for you.`,
  ],
  steps: [
    ...
    { name: 'Use Subscription Tamer to identify and decode them automatically', body: 'Paste the statement into Subscription Tamer and its Sweep scan decodes processor prefixes and obscure merchant strings into actual service names — "AMZN*Prime" resolves to Amazon Prime, "GOOGLE *YouTubePrem" to YouTube Premium — while ignoring the one-time purchases around them. Each decoded charge lands in your subscription list with its real cost, an honest keep-or-cancel verdict, and cancellation steps if you want it gone. From cryptic to actionable in seconds.' }
  ],
  cta: {
    glyph:    '⚔️',
    headline: "Find every recurring charge. Cut what you do not use.",
    body:     "Drop your statement into Subscription Tamer and Sweep finds the recurring charges, runs the cost-per-use math, and hands each one an honest keep-or-cancel verdict with step-by-step cancellation instructions. Price tracking then flags future hikes automatically.",
    features: [
      "Statement scan finds hidden recurring charges",
