module.exports = {
  ...
  ledes: [
    ...
    `Here is the ten-minute version — and how Subscription Tamer does most of it for you.`,
  ],
  steps: [
    ...
    { name: 'Use Subscription Tamer to do the search automatically', body: 'Paste your statement into Subscription Tamer\'s Sweep and it identifies every recurring charge — including ones hiding behind cryptic merchant names like "AMZN*Prime" or "GOOGLE *YouTubePrem" that a manual sweep misses — and turns them into a subscription list with real costs. Then it goes one step past inventory: each subscription gets an honest keep-or-cancel verdict with cost-per-use math and step-by-step cancellation instructions, and Radar watches your upcoming renewals so the audit stays done.' }
  ],
  cta: {
    glyph:    '⚔️',
    headline: "Find every recurring charge. Cut what you do not use.",
    body:     "Subscription Tamer's Sweep is the 10-minute audit: add your subscriptions or scan a statement, and get keep-or-cancel verdicts with cost-per-use math and cancellation steps. Radar then keeps watching your renewals, so you never have to re-audit from scratch.",
    features: [
      "Add subscriptions manually or scan a statement",
      "Keep/cancel verdicts with cost-per-use math",
