module.exports = {
  slug:          'how-to-cancel-a-subscription-that-wont-let-you-cancel',
  category:      'money',
  categoryLabel: 'Money',

  title:         "How to Cancel a Subscription That Won't Let You Cancel (And When It's Actually Illegal)",
  titleHtml:     "How to Cancel a Subscription That Won&#39;t Let You Cancel <em>(And When It&#39;s Actually Illegal)</em>",
  shortTitle:    "How to Cancel a Subscription That Won't Let You Cancel",
  navTitle:      "How to cancel a subscription that won't let you cancel and when it's actually illegal",

  description:   "Companies design cancellation flows to make leaving exhausting. The flows have predictable patterns — and predictable countermoves — and several of the worst tactics are now actually against the law.",
  deck:          "Companies design cancellation flows to make leaving exhausting. The flows have predictable patterns — and predictable countermoves — and several of the worst tactics are now actually against the law.",
