module.exports = {
  slug:          'how-to-deal-with-a-retention-specialist',
  category:      'money',
  categoryLabel: 'Money',

  title:         "How to Deal With a Retention Specialist (Without Getting Talked Into Staying)",
  titleHtml:     "How to Deal With a Retention Specialist <em>(Without Getting Talked Into Staying)</em>",
  shortTitle:    "How to Deal With a Retention Specialist",
  navTitle:      "How to deal with a retention specialist without getting talked into staying",

  description:   "Retention specialists aren't customer service. They're a separate role with a different job — and the job is keeping you. Knowing the difference changes how the call goes.",
  deck:          "Retention specialists aren't customer service. They're a separate role with a different job — and the job is keeping you. Knowing the difference changes how the call goes.",
  ...
  steps: [
    {
      name: "Recognize when you've been routed to retention",
    ...
    {
      name: "Understand their actual job: 'saves,' not service",
      body: "Retention specialists are usually evaluated on save rate — what percentage of customers who call to cancel end up not canceling. Their bonuses, their performance reviews, sometimes their continued employment depend on this number. They're not punished for offering you discounts they're authorized to offer; they're punished for letting you cancel without trying everything in their toolkit. This isn't conspiracy — it's just how the role is structured. Knowing the structure helps you not interpret their friendliness or their concessions as personal kindness. They're doing what they're paid to do.",
    },
    {
      name: "Don't explain your reasons — they're being collected",
