module.exports = {
  ...
  steps: [
    { name: 'For sound-only memories: hum it to a hum-search app', body: 'The hum-to-search feature in the Google app, or SoundHound, lets you hum the melody and identify the song. They work surprisingly well for popular songs even with imperfect humming. If you can produce the melody at all, this is the fastest path. The downside is they work best for songs that are well-known; obscure songs may not match. If your hum returns nothing, the song is probably either obscure or your hum is sufficiently off-key — try again on the chorus rather than the verse.' },
