module.exports = {
  ...
  ledes: [
    ...
    `Here is the conversion process — manually, and with The Crux doing the heavy lifting.`,
  ],
  steps: [
    ...
    { name: 'Use The Crux to do all of this in one pass', body: 'Paste the transcript into The Crux and pick Study Guide mode. It produces sectioned output organized into definitions, processes, key concepts, and questions — the structure above, automatically. Treat the output as a strong first draft, not the final product. Edit it: add the comparisons it missed, fix anything wrong. Five minutes of editing on top of The Crux\'s output beats ninety minutes of structuring from scratch.' }
  ],
  cta: {
    glyph:    '🧠',
