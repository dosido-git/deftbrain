module.exports = {
  slug:          'how-to-schedule-a-week-so-youre-not-constantly-switching-gears',
  category:      'wellness',
  categoryLabel: 'Wellness',

  title:         "How to Schedule a Week So You're Not Constantly Switching Gears",
  titleHtml:     "How to Schedule a Week So You&#39;re Not Constantly Switching Gears",
  ...
  steps: [
    {
      name: "Pick a theme for each day, even loosely",
    ...
    {
      name: "Defend two mornings, not five",
    ...
    {
      name: "Make Friday afternoon do the wrap-up work",
      body: "The pile of small things that you keep saying you'll get to — the email reply, the expense report, the doc edit, the follow-up message — has its own home now. Friday afternoon. Two hours, low expectations, doors open. Knowing those things have a designated time stops them from polluting every other block of the week. They were never going to get done in the deep-work block anyway.",
    },
    {
      name: "Protect the system, not the specific blocks",
      body: "The schedule will get violated. Someone will book over your protected morning. A fire will eat your deep-work block. That's normal. The skill is preserving the system across weeks, not any specific block in any specific week. If your week gets blown up, don't restart from scratch — restart from the defaults. The defaults will rebuild the shape on their own.",
    },
  ],

  cta: {
    glyph:    '⚡',
    headline: "Reshape your week — without overhauling your calendar",
    body:     "List your tasks and fixed commitments, and Batch Flow groups them by the kind of thinking each one needs — then builds a batched schedule around your energy pattern and day type, so the week has fewer gear shifts without a calendar overhaul.",
    features: [
      "Groups tasks by mental mode, not topic",
      "Schedules high-focus batches at your energy peak",
      "Works around the fixed commitments you enter",
      "Day types — Maker Day, Meetings Day, Admin Day",
      "Weekly Rhythm builds a repeatable batching pattern",
    ],
    toolId:   'BatchFlow',
    toolName: 'Batch Flow',
  },
