module.exports = {
  slug:          'why-scheduled-rest-never-feels-like-enough',
  category:      'wellness',
  categoryLabel: 'Wellness',
  title:         "Why Scheduled Rest Never Feels Like Enough",
  titleHtml:     "Why Scheduled Rest <em>Never Feels Like Enough</em>",
  shortTitle:    "When Rest Feels Empty",
  navTitle:      "when rest feels empty",
  description:   "You took the day off. You did nothing. You still feel tired Monday morning. Here is why scheduled rest often fails — and how to make it actually restorative.",
  deck:          "You took the day off. You did nothing. You still feel tired Monday morning. Here is why scheduled rest often fails — and how to make it actually restorative.",
  ledes: [
    `You blocked off the whole Saturday. You said no to plans. You stayed in pajamas, watched a couple of movies, scrolled your phone, took a nap. By Sunday night you felt vaguely behind on everything and not actually rested. Monday morning you were tired again before noon.\n\nIt is not that the rest day failed because you did the wrong thing on it. It is that scheduled-do-nothing days have a structural problem: they fill with low-grade input — phone, news, email-checking, light social media — that drains the same energy you were trying to restore. Rest is not the absence of activity. It is the absence of input.`,
    `Here is what makes rest actually work — and how to spot when yours is not.`,
  ],
  steps: [
    { name: 'Rest fails when it is full of low-grade input', body: 'Scrolling for six hours is not rest. It is a continuous stream of small social and cognitive inputs that drain the exact battery the day was supposed to recharge. The fact that it does not feel like work does not mean it is restorative. The test is how you feel afterward — if you feel scattered, vaguely anxious, and not refreshed, the input drained you even though you were sitting still.' },
