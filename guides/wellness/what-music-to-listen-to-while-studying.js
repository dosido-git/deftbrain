module.exports = {
  slug:          'what-music-to-listen-to-while-studying',
  category:      'wellness',
  categoryLabel: 'Wellness',

  title:         "What Music to Listen to While Studying (That Actually Helps Instead of Distracting)",
  titleHtml:     "What Music to Listen to While Studying <em>(That Actually Helps Instead of Distracting)</em>",
  ...
  steps: [
    ...
    },
    {
      ...
      body: "Slow, ambient music works for sustained reading and deep absorption. Faster, more rhythmic music works for repetitive tasks — flashcards, problem sets, drilling. If you're trying to power through volume, BPM matters; if you're trying to think carefully, it doesn't. The error is using high-energy music for tasks that need contemplation, or sleepy music for tasks that need momentum.",
    },
    {
      name: "Use familiar music for focus, unfamiliar for breaks",
      body: "Music you know well doesn't pull your attention because your brain has already processed it. Music you've never heard does pull attention — you're tracking what comes next. For focus, use playlists you've heard a thousand times. Save the new music for breaks, walks, or low-cognitive tasks. Most studying-music failures come from putting on a fresh playlist as a treat and discovering you've been auditioning songs instead of reading.",
    },
    {
      name: "Watch the volume — louder is rarely better",
      body: "Loud music narrows your attention to itself. The volume that helps focus is just loud enough to mask environmental noise (the AC, the people downstairs) without becoming the focus itself. As a rule: if you can hear yourself think clearly while it's playing, the volume is right. If thoughts feel like they're being pushed through the music, it's too loud.",
    },
    {
      name: "Pre-build playlists, don't browse mid-session",
      body: "The biggest leak isn't the wrong music — it's the time you spend choosing music. Every five minutes spent picking songs is five minutes you weren't studying. Build two or three go-to playlists in advance, hit play once, and don't touch the controls. The discipline is at the start; let the playlist make all the song decisions for you.",
    },
  ],

  cta: {
    glyph:    '🎧',
    headline: "Get a study playlist tuned to your actual task",
    body:     "Brain State Deejay matches music to the cognitive demand of what you're doing — language-brain vs spatial-brain, drilling vs absorption — and serves the right thing.",
    features: [
      "Task-tuned playlists",
      "Lyric-aware filtering",
      "Tempo matched to energy needs",
      "Familiar-music focus mode",
      "One-tap start",
    ],
    toolId:   'BrainStateDeejay',
    toolName: 'Brain State Deejay',
  },
