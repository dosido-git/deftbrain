module.exports = {
  slug:          'how-to-prioritize-when-everything-feels-urgent',
  category:      'wellness',
  categoryLabel: 'Wellness',
  title:         "How to Prioritize When Everything Feels Urgent",
  titleHtml:     "How to Prioritize <em>(When Everything Feels Urgent)</em>",
  shortTitle:    "Prioritize When Everything's Urgent",
  navTitle:      "prioritize when everything's urgent",
  description:   "Every task feels critical. None can wait. Here's how to find the actual order — fast, in five minutes, while the panic's still loud.",
  deck:          "Every task feels critical. None can wait. Here's how to find the actual order — fast, in five minutes, while the panic's still loud.",
  ledes: [
