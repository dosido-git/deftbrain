module.exports = {
  slug:          'how-to-calm-your-nerves-before-an-interview',
  category:      'wellness',
  categoryLabel: 'Wellness',
  title:         "How to Calm Your Nerves Before an Interview",
  titleHtml:     "How to Calm Your Nerves <em>Before an Interview</em>",
  shortTitle:    "Calm Pre-Interview Nerves",
  navTitle:      "calm interview nerves",
  description:   "The hour before an interview is the worst hour. Here is a structure for it that actually settles you down.",
  deck:          "The hour before an interview is the worst hour. Here is a structure for it that actually settles you down.",
  ledes: [
    `It is forty-five minutes before your interview. You are sitting in a coffee shop near the office, or on the couch waiting for the video call, and your heart is doing the thing — slightly too fast, slightly too loud — and your hands are cold, and you are reading your own notes for the fifth time without any of the words actually registering. You know logically you have prepped. The body did not get the memo.\n\nNerves before an interview are not a sign you are not ready. They are a sign your nervous system has correctly identified that this matters. The goal is not to make the nerves vanish — that is not how nervous systems work — but to give them a structure and burn off enough of the activation that you walk in present rather than spiked. The structure is the thing. Without it, the forty-five minutes will eat you. With it, you will arrive level.`,
