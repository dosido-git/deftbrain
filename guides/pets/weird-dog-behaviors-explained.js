...
module.exports = {
  ...
  cta: {
    ...
    body:     "This guide covers five common patterns. Pet Behavior Decoder takes whatever your dog is actually doing — the specific behavior, the timeline, what changed — and gives you a personalized triage read: reassure, watch and wait, or call the vet today.",
    features: [
